...
buildRosPackage {
  ...
  checkInputs = [ ament_cmake_pytest ament_lint_auto ament_lint_common launch launch_ros launch_testing launch_testing_ament_cmake python3Packages.opencv4 python_cmake_module rclpy ros_testing ];
  missingDependencies = [  ];
  meta = {
