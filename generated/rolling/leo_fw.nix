...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ ament_index_python geometry_msgs leo_msgs libyamlcpp nav_msgs python3Packages.dbus-python python3Packages.numpy python3Packages.whichcraft rclcpp rclcpp_components rclpy ros2cli sensor_msgs std_msgs std_srvs ];
  depsTargetTarget = [  ];
