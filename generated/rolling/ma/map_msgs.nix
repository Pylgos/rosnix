...
let
  sources = rec {
    map_msgs-e8b77b13c76675dc8907ea9cda406140e6ab9329 = substituteSource {
      src = fetchgit {
        name = "map_msgs-e8b77b13c76675dc8907ea9cda406140e6ab9329-source";
...
buildRosPackage {
  pname = "map_msgs";
  version = "2.5.0-1";
  src = sources.map_msgs-e8b77b13c76675dc8907ea9cda406140e6ab9329;
