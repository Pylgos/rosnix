...
let
  sources = rec {
    mavros_msgs-98c65be6302c0ca9ffa9d627c43f1a8747119386 = substituteSource {
      src = fetchgit {
        name = "mavros_msgs-98c65be6302c0ca9ffa9d627c43f1a8747119386-source";
...
buildRosPackage {
  pname = "mavros_msgs";
  version = "2.8.0-1";
  src = sources.mavros_msgs-98c65be6302c0ca9ffa9d627c43f1a8747119386;
