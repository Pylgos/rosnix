...
let
  sources = rec {
    radar_msgs-bb0b8b238628c1200c0aade2ebf6be2768a5a602 = substituteSource {
      src = fetchgit {
        name = "radar_msgs-bb0b8b238628c1200c0aade2ebf6be2768a5a602-source";
...
buildRosPackage {
  pname = "radar_msgs";
  version = "0.2.2-3";
  src = sources.radar_msgs-bb0b8b238628c1200c0aade2ebf6be2768a5a602;
