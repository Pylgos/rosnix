...
let
  sources = rec {
    examples_rclcpp_minimal_client-6fad09dc532a16635534a5e2ea3521bcc164502b = substituteSource {
      src = fetchgit {
        name = "examples_rclcpp_minimal_client-6fad09dc532a16635534a5e2ea3521bcc164502b-source";
...
buildRosPackage {
  ...
  version = "0.20.2-1";
  src = sources.examples_rclcpp_minimal_client-6fad09dc532a16635534a5e2ea3521bcc164502b;
