...
let
  sources = rec {
    ...
    ecal-vendor_source-npcap-sdk-1-3 = substituteSource {
      src = fetchzip {
        name = "ecal-vendor_source-npcap-sdk-1-3-source";
