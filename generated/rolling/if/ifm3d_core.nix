...
let
  sources = rec {
    ifm3d_core-01aa8970b76959a9bb14540b198f52f4c4316936 = substituteSource {
      src = fetchgit {
        name = "ifm3d_core-01aa8970b76959a9bb14540b198f52f4c4316936-source";
...
buildRosPackage {
  pname = "ifm3d_core";
  version = "0.18.0-9";
  src = sources.ifm3d_core-01aa8970b76959a9bb14540b198f52f4c4316936;
