...
let
  sources = rec {
    ...
    yaml_cpp_vendor-9e9bcdb19d0f039cda3f7b85d7d1967375ed4e75 = substituteSource {
      src = fetchgit {
        name = "yaml_cpp_vendor-9e9bcdb19d0f039cda3f7b85d7d1967375ed4e75-source";
...
buildRosPackage {
  ...
  version = "9.1.0-1";
  src = sources.yaml_cpp_vendor-9e9bcdb19d0f039cda3f7b85d7d1967375ed4e75;
