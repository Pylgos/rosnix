...
let
  sources = rec {
    leo_desktop-66b0c66db9bc1aabf02c8cb22c96a19008a0e114 = substituteSource {
      src = fetchgit {
        name = "leo_desktop-66b0c66db9bc1aabf02c8cb22c96a19008a0e114-source";
...
buildRosPackage {
  pname = "leo_desktop";
  version = "3.0.0-2";
  src = sources.leo_desktop-66b0c66db9bc1aabf02c8cb22c96a19008a0e114;
