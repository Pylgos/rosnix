...
let
  sources = rec {
    ecl_ipc-ad04db545c181ad8f345bd60885142552ddd44c1 = substituteSource {
      src = fetchgit {
        name = "ecl_ipc-ad04db545c181ad8f345bd60885142552ddd44c1-source";
...
buildRosPackage {
  pname = "ecl_ipc";
  version = "1.2.1-4";
  src = sources.ecl_ipc-ad04db545c181ad8f345bd60885142552ddd44c1;
