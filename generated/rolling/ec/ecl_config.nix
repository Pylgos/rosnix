...
let
  sources = rec {
    ecl_config-239cbce5d68a90bf4402374d969e80bc29e9651b = substituteSource {
      src = fetchgit {
        name = "ecl_config-239cbce5d68a90bf4402374d969e80bc29e9651b-source";
...
buildRosPackage {
  pname = "ecl_config";
  version = "1.2.0-4";
  src = sources.ecl_config-239cbce5d68a90bf4402374d969e80bc29e9651b;
