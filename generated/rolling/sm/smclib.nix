...
let
  sources = rec {
    smclib-8623a74afcd34db200176962b2d57582002da0f8 = substituteSource {
      src = fetchgit {
        name = "smclib-8623a74afcd34db200176962b2d57582002da0f8-source";
...
buildRosPackage {
  pname = "smclib";
  version = "4.1.0-1";
  src = sources.smclib-8623a74afcd34db200176962b2d57582002da0f8;
