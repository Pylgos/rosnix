...
let
  sources = rec {
    gz_launch-vendor_source-1317511d365d1b2c312c86f9062b8a4b7bfdc132 = substituteSource {
      src = fetchgit {
        name = "gz_launch-vendor_source-1317511d365d1b2c312c86f9062b8a4b7bfdc132-source";
    ...
    gz_launch_vendor-1d308be03d2a82a9b13d8a3fddab7e9a1227b191 = substituteSource {
      src = fetchgit {
        name = "gz_launch_vendor-1d308be03d2a82a9b13d8a3fddab7e9a1227b191-source";
      ...
      substitutions = [
        {
          ...
          to = "VCS_TYPE path VCS_URL ${gz_launch-vendor_source-1317511d365d1b2c312c86f9062b8a4b7bfdc132}";
        }
      ];
    };
  };
...
buildRosPackage {
  ...
  version = "0.1.1-1";
  src = sources.gz_launch_vendor-1d308be03d2a82a9b13d8a3fddab7e9a1227b191;
