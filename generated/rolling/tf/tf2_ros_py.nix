...
let
  sources = rec {
    tf2_ros_py-e4a5e5745a0688bc97c6ecef8c79c5710818d89a = substituteSource {
      src = fetchgit {
        name = "tf2_ros_py-e4a5e5745a0688bc97c6ecef8c79c5710818d89a-source";
...
buildRosPackage {
  pname = "tf2_ros_py";
  version = "0.38.2-1";
  src = sources.tf2_ros_py-e4a5e5745a0688bc97c6ecef8c79c5710818d89a;
