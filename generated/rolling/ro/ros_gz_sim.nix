...
let
  sources = rec {
    ros_gz_sim-ef0e4f0667e5221433e0062028997270cd4c28d7 = substituteSource {
      src = fetchgit {
        name = "ros_gz_sim-ef0e4f0667e5221433e0062028997270cd4c28d7-source";
...
buildRosPackage {
  pname = "ros_gz_sim";
  version = "2.1.0-1";
  src = sources.ros_gz_sim-ef0e4f0667e5221433e0062028997270cd4c28d7;
