...
let
  sources = rec {
    ros_testing-56f6ba90ce5a80ef42bb8a398d1f9b427626c864 = substituteSource {
      src = fetchgit {
        name = "ros_testing-56f6ba90ce5a80ef42bb8a398d1f9b427626c864-source";
...
buildRosPackage {
  pname = "ros_testing";
  version = "0.7.0-1";
  src = sources.ros_testing-56f6ba90ce5a80ef42bb8a398d1f9b427626c864;
