...
let
  sources = rec {
    rosidl_adapter-af4b8d01d7b62ded8040ff8afae03002315bbb8d = substituteSource {
      src = fetchgit {
        name = "rosidl_adapter-af4b8d01d7b62ded8040ff8afae03002315bbb8d-source";
...
buildRosPackage {
  ...
  version = "4.8.1-1";
  src = sources.rosidl_adapter-af4b8d01d7b62ded8040ff8afae03002315bbb8d;
