...
let
  sources = rec {
    ros2action-9438bf45f3208dffee15a8c9bbe85bd9a868865e = substituteSource {
      src = fetchgit {
        name = "ros2action-9438bf45f3208dffee15a8c9bbe85bd9a868865e-source";
...
buildRosPackage {
  pname = "ros2action";
  version = "0.34.1-1";
  src = sources.ros2action-9438bf45f3208dffee15a8c9bbe85bd9a868865e;
