...
let
  sources = rec {
    rosidl_generator_c-d3189fbf89aad16ab7e1339774623b4fb4a51f25 = substituteSource {
      src = fetchgit {
        name = "rosidl_generator_c-d3189fbf89aad16ab7e1339774623b4fb4a51f25-source";
...
buildRosPackage {
  ...
  version = "4.8.1-1";
  src = sources.rosidl_generator_c-d3189fbf89aad16ab7e1339774623b4fb4a51f25;
