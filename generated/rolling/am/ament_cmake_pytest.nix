...
let
  sources = rec {
    ament_cmake_pytest-1ec3b8a8583861017c37dc8fd9e39a08f18b0944 = substituteSource {
      src = fetchgit {
        name = "ament_cmake_pytest-1ec3b8a8583861017c37dc8fd9e39a08f18b0944-source";
...
buildRosPackage {
  ...
  version = "2.7.0-1";
  src = sources.ament_cmake_pytest-1ec3b8a8583861017c37dc8fd9e39a08f18b0944;
