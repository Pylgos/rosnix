...
let
  sources = rec {
    ament_cmake_vendor_package-8a65d8812e213b00f90cfcf92c2d062b328f8b37 = substituteSource {
      src = fetchgit {
        name = "ament_cmake_vendor_package-8a65d8812e213b00f90cfcf92c2d062b328f8b37-source";
...
buildRosPackage {
  ...
  version = "2.7.0-1";
  src = sources.ament_cmake_vendor_package-8a65d8812e213b00f90cfcf92c2d062b328f8b37;
