...
let
  sources = rec {
    ament_cmake_mypy-91810f41709319202fbfcff3e05e295b6f1962af = substituteSource {
      src = fetchgit {
        name = "ament_cmake_mypy-91810f41709319202fbfcff3e05e295b6f1962af-source";
...
buildRosPackage {
  ...
  version = "0.18.1-1";
  src = sources.ament_cmake_mypy-91810f41709319202fbfcff3e05e295b6f1962af;
