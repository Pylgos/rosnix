...
let
  sources = rec {
    ament_clang_tidy-80379c201c84a14aefce3017c096aef5ae5a1ecc = substituteSource {
      src = fetchgit {
        name = "ament_clang_tidy-80379c201c84a14aefce3017c096aef5ae5a1ecc-source";
...
buildRosPackage {
  ...
  version = "0.18.1-1";
  src = sources.ament_clang_tidy-80379c201c84a14aefce3017c096aef5ae5a1ecc;
