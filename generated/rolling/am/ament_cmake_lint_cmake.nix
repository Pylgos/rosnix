...
let
  sources = rec {
    ament_cmake_lint_cmake-fb34b082d5c244046734d507d4a5be7197930e65 = substituteSource {
      src = fetchgit {
        name = "ament_cmake_lint_cmake-fb34b082d5c244046734d507d4a5be7197930e65-source";
...
buildRosPackage {
  ...
  version = "0.18.1-1";
  src = sources.ament_cmake_lint_cmake-fb34b082d5c244046734d507d4a5be7197930e65;
