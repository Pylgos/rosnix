...
let
  sources = rec {
    rt_manipulators_examples-39e0ef864ab63defcde598d3c0007bba775f4018 = substituteSource {
      src = fetchgit {
        name = "rt_manipulators_examples-39e0ef864ab63defcde598d3c0007bba775f4018-source";
...
buildRosPackage {
  ...
  version = "1.0.0-3";
  src = sources.rt_manipulators_examples-39e0ef864ab63defcde598d3c0007bba775f4018;
