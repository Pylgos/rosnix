...
let
  sources = rec {
    moveit_resources_fanuc_moveit_config-2f769a648d8da53a6857291a8f3a9338f78d0371 = substituteSource {
      src = fetchgit {
        name = "moveit_resources_fanuc_moveit_config-2f769a648d8da53a6857291a8f3a9338f78d0371-source";
...
buildRosPackage {
  ...
  version = "3.0.0-2";
  src = sources.moveit_resources_fanuc_moveit_config-2f769a648d8da53a6857291a8f3a9338f78d0371;
