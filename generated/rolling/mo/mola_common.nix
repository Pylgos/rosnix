...
let
  sources = rec {
    mola_common-5ac43ad82c58ebe66a9ec65bf475744de841e42f = substituteSource {
      src = fetchgit {
        name = "mola_common-5ac43ad82c58ebe66a9ec65bf475744de841e42f-source";
...
buildRosPackage {
  pname = "mola_common";
  version = "0.4.0-1";
  src = sources.mola_common-5ac43ad82c58ebe66a9ec65bf475744de841e42f;
