...
let
  sources = rec {
    interactive_marker_twist_server-a614494c6cd56baf9e33e1f965c91cab37f76cb9 = substituteSource {
      src = fetchgit {
        name = "interactive_marker_twist_server-a614494c6cd56baf9e33e1f965c91cab37f76cb9-source";
...
buildRosPackage {
  ...
  version = "2.1.0-2";
  src = sources.interactive_marker_twist_server-a614494c6cd56baf9e33e1f965c91cab37f76cb9;
