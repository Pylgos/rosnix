...
let
  sources = rec {
    py_trees_js-2765e2118720c872073470aaae6172497b80e68c = substituteSource {
      src = fetchgit {
        name = "py_trees_js-2765e2118720c872073470aaae6172497b80e68c-source";
...
buildRosPackage {
  pname = "py_trees_js";
  version = "0.6.4-3";
  src = sources.py_trees_js-2765e2118720c872073470aaae6172497b80e68c;
