...
let
  sources = rec {
    trac_ik_lib-f05b24476d03bb7879a7a95b49c9820463c89bf9 = substituteSource {
      src = fetchgit {
        name = "trac_ik_lib-f05b24476d03bb7879a7a95b49c9820463c89bf9-source";
...
buildRosPackage {
  pname = "trac_ik_lib";
  version = "2.0.1-1";
  src = sources.trac_ik_lib-f05b24476d03bb7879a7a95b49c9820463c89bf9;
