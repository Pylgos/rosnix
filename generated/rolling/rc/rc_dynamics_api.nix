...
let
  sources = rec {
    rc_dynamics_api-5a56399da72a6ebe28a7701f1717a0e5308c7003 = substituteSource {
      src = fetchgit {
        name = "rc_dynamics_api-5a56399da72a6ebe28a7701f1717a0e5308c7003-source";
...
buildRosPackage {
  ...
  version = "0.10.5-1";
  src = sources.rc_dynamics_api-5a56399da72a6ebe28a7701f1717a0e5308c7003;
