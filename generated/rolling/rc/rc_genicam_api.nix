...
let
  sources = rec {
    rc_genicam_api-71681af0a8b4ba1871e5da13cfe4208ed92394e4 = substituteSource {
      src = fetchgit {
        name = "rc_genicam_api-71681af0a8b4ba1871e5da13cfe4208ed92394e4-source";
...
buildRosPackage {
  ...
  version = "2.6.5-1";
  src = sources.rc_genicam_api-71681af0a8b4ba1871e5da13cfe4208ed92394e4;
