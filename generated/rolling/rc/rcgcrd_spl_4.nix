...
let
  sources = rec {
    rcgcrd_spl_4-7612ae795501c4bbd159a824ce3ebf24c349ac4e = substituteSource {
      src = fetchgit {
        name = "rcgcrd_spl_4-7612ae795501c4bbd159a824ce3ebf24c349ac4e-source";
...
buildRosPackage {
  pname = "rcgcrd_spl_4";
  version = "4.0.1-1";
  src = sources.rcgcrd_spl_4-7612ae795501c4bbd159a824ce3ebf24c349ac4e;
