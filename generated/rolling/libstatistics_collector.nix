...
buildRosPackage {
  ...
  checkInputs = [ ament_cmake_gtest ament_lint_auto ament_lint_common performance_test_fixture rcutils rosidl_default_generators rosidl_default_runtime std_msgs ];
  missingDependencies = [  ];
  meta = {
