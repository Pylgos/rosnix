...
buildRosPackage {
  ...
  nativeBuildInputs = [  ];
  propagatedNativeBuildInputs = [ ament_cmake ament_cmake_auto ament_cmake_gmock ament_cmake_gtest ament_cmake_pytest ament_cmake_ros ament_lint_auto ament_lint_common launch_testing_ament_cmake ros_environment rosidl_default_generators ];
  buildInputs = [  ];
