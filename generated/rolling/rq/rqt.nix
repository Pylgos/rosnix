...
let
  sources = rec {
    rqt-f575ef11e4b5354b169b17509a12db2b0699f6fd = substituteSource {
      src = fetchgit {
        name = "rqt-f575ef11e4b5354b169b17509a12db2b0699f6fd-source";
...
buildRosPackage {
  pname = "rqt";
  version = "1.7.2-1";
  src = sources.rqt-f575ef11e4b5354b169b17509a12db2b0699f6fd;
