...
let
  sources = rec {
    ur_msgs-b8efa2c50cdaac03d89de517c575de9982bda0a0 = substituteSource {
      src = fetchgit {
        name = "ur_msgs-b8efa2c50cdaac03d89de517c575de9982bda0a0-source";
...
buildRosPackage {
  pname = "ur_msgs";
  version = "2.0.0-3";
  src = sources.ur_msgs-b8efa2c50cdaac03d89de517c575de9982bda0a0;
