...
let
  sources = rec {
    cmake_generate_parameter_module_example-9fd41b460ee9bbb3e861e0b8199a8e6fc3639832 = substituteSource {
      src = fetchgit {
        name = "cmake_generate_parameter_module_example-9fd41b460ee9bbb3e861e0b8199a8e6fc3639832-source";
...
buildRosPackage {
  ...
  version = "0.3.8-3";
  src = sources.cmake_generate_parameter_module_example-9fd41b460ee9bbb3e861e0b8199a8e6fc3639832;
