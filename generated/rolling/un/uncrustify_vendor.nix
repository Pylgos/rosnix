...
let
  sources = rec {
    ...
    uncrustify_vendor-1305134544d1939805a070f24b44ec66ce3baf0c = substituteSource {
      src = fetchgit {
        name = "uncrustify_vendor-1305134544d1939805a070f24b44ec66ce3baf0c-source";
...
buildRosPackage {
  ...
  version = "3.1.0-1";
  src = sources.uncrustify_vendor-1305134544d1939805a070f24b44ec66ce3baf0c;
