...
let
  sources = rec {
    rmf_traffic_msgs-bf1014f5ce214124bc6db4b4b2155fb3438f4944 = substituteSource {
      src = fetchgit {
        name = "rmf_traffic_msgs-bf1014f5ce214124bc6db4b4b2155fb3438f4944-source";
...
buildRosPackage {
  ...
  version = "3.4.0-1";
  src = sources.rmf_traffic_msgs-bf1014f5ce214124bc6db4b4b2155fb3438f4944;
