...
let
  sources = rec {
    rmf_traffic_ros2-8fe01ade5f770221dc54219ee829cd4c0d071408 = substituteSource {
      src = fetchgit {
        name = "rmf_traffic_ros2-8fe01ade5f770221dc54219ee829cd4c0d071408-source";
...
buildRosPackage {
  ...
  version = "2.7.1-1";
  src = sources.rmf_traffic_ros2-8fe01ade5f770221dc54219ee829cd4c0d071408;
