...
let
  sources = rec {
    rmf_robot_sim_gz_plugins-11d58025c76c49d43b177e2530189772ed8da5ac = substituteSource {
      src = fetchgit {
        name = "rmf_robot_sim_gz_plugins-11d58025c76c49d43b177e2530189772ed8da5ac-source";
...
buildRosPackage {
  ...
  version = "2.4.0-1";
  src = sources.rmf_robot_sim_gz_plugins-11d58025c76c49d43b177e2530189772ed8da5ac;
