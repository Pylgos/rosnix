...
let
  sources = rec {
    rmf_utils-b2d4278fa266a69fc67541c312a63c564ba7c76b = substituteSource {
      src = fetchgit {
        name = "rmf_utils-b2d4278fa266a69fc67541c312a63c564ba7c76b-source";
...
buildRosPackage {
  pname = "rmf_utils";
  version = "1.7.0-1";
  src = sources.rmf_utils-b2d4278fa266a69fc67541c312a63c564ba7c76b;
