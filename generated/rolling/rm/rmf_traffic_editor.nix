...
let
  sources = rec {
    rmf_traffic_editor-f78be64194865cd2eafe6ed22c85b8fbc2308024 = substituteSource {
      src = fetchgit {
        name = "rmf_traffic_editor-f78be64194865cd2eafe6ed22c85b8fbc2308024-source";
...
buildRosPackage {
  ...
  version = "1.10.0-1";
  src = sources.rmf_traffic_editor-f78be64194865cd2eafe6ed22c85b8fbc2308024;
