...
let
  sources = rec {
    joy-f445427e97a65ec06798dcbe1652890fa056c1fa = substituteSource {
      src = fetchgit {
        name = "joy-f445427e97a65ec06798dcbe1652890fa056c1fa-source";
...
buildRosPackage {
  pname = "joy";
  version = "3.3.0-2";
  src = sources.joy-f445427e97a65ec06798dcbe1652890fa056c1fa;
