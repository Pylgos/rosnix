...
let
  sources = rec {
    gc_spl-7db7532c5833d2fd25edbad3bf25ebcf77a64a45 = substituteSource {
      src = fetchgit {
        name = "gc_spl-7db7532c5833d2fd25edbad3bf25ebcf77a64a45-source";
...
buildRosPackage {
  pname = "gc_spl";
  version = "4.0.1-1";
  src = sources.gc_spl-7db7532c5833d2fd25edbad3bf25ebcf77a64a45;
