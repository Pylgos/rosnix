...
let
  sources = rec {
    sensor_msgs_py-01387914c80c8a75bea8b032db9310c0370c49eb = substituteSource {
      src = fetchgit {
        name = "sensor_msgs_py-01387914c80c8a75bea8b032db9310c0370c49eb-source";
...
buildRosPackage {
  ...
  version = "5.4.1-1";
  src = sources.sensor_msgs_py-01387914c80c8a75bea8b032db9310c0370c49eb;
