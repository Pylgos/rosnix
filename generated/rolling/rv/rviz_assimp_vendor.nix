...
let
  sources = rec {
    ...
    rviz_assimp_vendor-8a5a332c56c44519817bcd953774977f20c1160b = substituteSource {
      src = fetchgit {
        name = "rviz_assimp_vendor-8a5a332c56c44519817bcd953774977f20c1160b-source";
...
buildRosPackage {
  ...
  version = "14.2.6-1";
  src = sources.rviz_assimp_vendor-8a5a332c56c44519817bcd953774977f20c1160b;
