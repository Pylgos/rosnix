...
let
  sources = rec {
    xacro-b40362a1d5d97599cac992900b0177b36308c257 = substituteSource {
      src = fetchgit {
        name = "xacro-b40362a1d5d97599cac992900b0177b36308c257-source";
...
buildRosPackage {
  pname = "xacro";
  version = "2.0.11-1";
  src = sources.xacro-b40362a1d5d97599cac992900b0177b36308c257;
