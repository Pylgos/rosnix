...
let
  sources = rec {
    ompl-6b1fa1f0baf2de6714b624a1327a4772669c1efc = substituteSource {
      src = fetchgit {
        name = "ompl-6b1fa1f0baf2de6714b624a1327a4772669c1efc-source";
...
buildRosPackage {
  pname = "ompl";
  version = "1.6.0-1";
  src = sources.ompl-6b1fa1f0baf2de6714b624a1327a4772669c1efc;
