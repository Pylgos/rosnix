...
let
  sources = rec {
    launch_pytest-3acd59eeae5ebd94f72318691bc04750736bc459 = substituteSource {
      src = fetchgit {
        name = "launch_pytest-3acd59eeae5ebd94f72318691bc04750736bc459-source";
...
buildRosPackage {
  pname = "launch_pytest";
  version = "3.6.1-1";
  src = sources.launch_pytest-3acd59eeae5ebd94f72318691bc04750736bc459;
