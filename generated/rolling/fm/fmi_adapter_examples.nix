...
let
  sources = rec {
    fmi_adapter_examples-a6889685823269750f2f825fce47be547fc5308b = substituteSource {
      src = fetchgit {
        name = "fmi_adapter_examples-a6889685823269750f2f825fce47be547fc5308b-source";
...
buildRosPackage {
  ...
  version = "2.1.2-2";
  src = sources.fmi_adapter_examples-a6889685823269750f2f825fce47be547fc5308b;
