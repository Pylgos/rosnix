...
let
  sources = rec {
    fmi_adapter-4d5abe287d3113eed130e46e8f4c0cab8fa90d14 = substituteSource {
      src = fetchgit {
        name = "fmi_adapter-4d5abe287d3113eed130e46e8f4c0cab8fa90d14-source";
...
buildRosPackage {
  pname = "fmi_adapter";
  version = "2.1.2-2";
  src = sources.fmi_adapter-4d5abe287d3113eed130e46e8f4c0cab8fa90d14;
