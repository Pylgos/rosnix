...
let
  sources = rec {
    fuse_models-3618a5cdd9d36599d308209067b94698f9b5b25b = substituteSource {
      src = fetchgit {
        name = "fuse_models-3618a5cdd9d36599d308209067b94698f9b5b25b-source";
...
buildRosPackage {
  pname = "fuse_models";
  version = "1.2.1-1";
  src = sources.fuse_models-3618a5cdd9d36599d308209067b94698f9b5b25b;
