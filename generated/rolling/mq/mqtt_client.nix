...
let
  sources = rec {
    mqtt_client-34964f34dae7ee98f8693d8f87142678b11e3763 = substituteSource {
      src = fetchgit {
        name = "mqtt_client-34964f34dae7ee98f8693d8f87142678b11e3763-source";
...
buildRosPackage {
  pname = "mqtt_client";
  version = "2.3.0-1";
  src = sources.mqtt_client-34964f34dae7ee98f8693d8f87142678b11e3763;
