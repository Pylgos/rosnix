...
let
  sources = rec {
    tlsf_cpp-875209961463330f80ea29ebf6597e6678135727 = substituteSource {
      src = fetchgit {
        name = "tlsf_cpp-875209961463330f80ea29ebf6597e6678135727-source";
...
buildRosPackage {
  pname = "tlsf_cpp";
  version = "0.18.1-1";
  src = sources.tlsf_cpp-875209961463330f80ea29ebf6597e6678135727;
