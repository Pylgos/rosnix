...
let
  sources = rec {
    rviz_ogre_vendor = substituteSource {
      ...
      substitutions = [
        ...
        }
        {
          ...
          to = "VCS_TYPE path VCS_URL ${rviz_ogre_vendor-vendor_source-ogre-1}";
        }
        {
          path = "CMakeLists.txt";
          from = "VCS_URL https://github.com/madler/zlib.git";
          to = "VCS_TYPE path VCS_URL ${rviz_ogre_vendor-vendor_source-zlib-0}";
        }
      ];
    };
    ...
    rviz_ogre_vendor-vendor_source-ogre-1 = substituteSource {
      src = fetchgit {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-source";
      ...
      substitutions = [
        {
          ...
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-freetype-2-1}";
        }
        {
          path = "CMake/Dependencies.cmake";
          from = "DOWNLOAD\n            https://libsdl.org/release/SDL2-2.0.10.tar.gz";
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-SDL2-2-1}";
        }
        {
          path = "CMake/Dependencies.cmake";
          from = "DOWNLOAD\n          https://github.com/assimp/assimp/archive/v5.0.1.tar.gz";
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v5-1}";
        }
        {
          path = "CMake/Dependencies.cmake";
          from = "DOWNLOAD\n        https://github.com/gdraheim/zziplib/archive/v0.13.71.tar.gz";
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v0-1}";
        }
        {
          path = "CMake/Dependencies.cmake";
          from = "DOWNLOAD\n        https://github.com/zeux/pugixml/releases/download/v1.10/pugixml-1.10.tar.gz";
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-pugixml-1-1}";
        }
        {
          path = "Components/Overlay/CMakeLists.txt";
          from = "DOWNLOAD\n        https://github.com/ocornut/imgui/archive/v1.79.tar.gz";
          to = "DOWNLOAD file://${rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v1-1}";
        }
      ];
    };
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-SDL2-2-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-SDL2-2-1-source";
    ...
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-freetype-2-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-freetype-2-1-source";
    ...
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-pugixml-1-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-pugixml-1-1-source";
    ...
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v0-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v0-1-source";
    ...
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v1-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v1-1-source";
    ...
    rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v5-1 = substituteSource {
      src = fetchurl {
        name = "rviz_ogre_vendor-vendor_source-ogre-1-vendor_source-v5-1-source";
    ...
    rviz_ogre_vendor-vendor_source-zlib-0 = substituteSource {
      src = fetchgit {
        name = "rviz_ogre_vendor-vendor_source-zlib-0-source";
