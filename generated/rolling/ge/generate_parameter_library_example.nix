...
let
  sources = rec {
    generate_parameter_library_example-521a41bf987af9060c240d049986641cf34bd0a8 = substituteSource {
      src = fetchgit {
        name = "generate_parameter_library_example-521a41bf987af9060c240d049986641cf34bd0a8-source";
...
buildRosPackage {
  ...
  version = "0.3.8-3";
  src = sources.generate_parameter_library_example-521a41bf987af9060c240d049986641cf34bd0a8;
