...
let
  sources = rec {
    mrpt_libobs-218a7b7e8ef84ecf8217ddef4909dcfc8b698604 = substituteSource {
      src = fetchgit {
        name = "mrpt_libobs-218a7b7e8ef84ecf8217ddef4909dcfc8b698604-source";
...
buildRosPackage {
  pname = "mrpt_libobs";
  version = "2.14.1-1";
  src = sources.mrpt_libobs-218a7b7e8ef84ecf8217ddef4909dcfc8b698604;
