...
let
  sources = rec {
    etsi_its_messages-8810ffc2df7167070ba7ac4ab13a9dc70c12318b = substituteSource {
      src = fetchgit {
        name = "etsi_its_messages-8810ffc2df7167070ba7ac4ab13a9dc70c12318b-source";
...
buildRosPackage {
  ...
  version = "2.2.0-1";
  src = sources.etsi_its_messages-8810ffc2df7167070ba7ac4ab13a9dc70c12318b;
