...
let
  sources = rec {
    etsi_its_coding-d492d86f12ec39ad78bb9a818dcf82412dc40b42 = substituteSource {
      src = fetchgit {
        name = "etsi_its_coding-d492d86f12ec39ad78bb9a818dcf82412dc40b42-source";
...
buildRosPackage {
  ...
  version = "2.2.0-1";
  src = sources.etsi_its_coding-d492d86f12ec39ad78bb9a818dcf82412dc40b42;
