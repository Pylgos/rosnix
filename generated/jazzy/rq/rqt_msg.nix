...
let
  sources = rec {
    rqt_msg-0171aafa8d1dd700e104ee98421ee4a5e4ea45d3 = substituteSource {
      src = fetchgit {
        name = "rqt_msg-0171aafa8d1dd700e104ee98421ee4a5e4ea45d3-source";
...
buildRosPackage {
  pname = "rqt_msg";
  version = "1.5.1-3";
  src = sources.rqt_msg-0171aafa8d1dd700e104ee98421ee4a5e4ea45d3;
