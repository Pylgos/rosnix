...
let
  sources = rec {
    trac_ik-92b5f9f982498bed253e7fe0aaccabb177014abb = substituteSource {
      src = fetchgit {
        name = "trac_ik-92b5f9f982498bed253e7fe0aaccabb177014abb-source";
...
buildRosPackage {
  pname = "trac_ik";
  version = "2.0.1-1";
  src = sources.trac_ik-92b5f9f982498bed253e7fe0aaccabb177014abb;
