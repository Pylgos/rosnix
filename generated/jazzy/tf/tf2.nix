...
let
  sources = rec {
    tf2-a3cde480eeca378e3175de43b0de526b31601694 = substituteSource {
      src = fetchgit {
        name = "tf2-a3cde480eeca378e3175de43b0de526b31601694-source";
...
buildRosPackage {
  pname = "tf2";
  version = "0.36.4-1";
  src = sources.tf2-a3cde480eeca378e3175de43b0de526b31601694;
