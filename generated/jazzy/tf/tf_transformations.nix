...
let
  sources = rec {
    tf_transformations-c623ec1a59d1afc184a119057bd42cba948a1722 = substituteSource {
      src = fetchgit {
        name = "tf_transformations-c623ec1a59d1afc184a119057bd42cba948a1722-source";
...
buildRosPackage {
  ...
  version = "1.1.0-1";
  src = sources.tf_transformations-c623ec1a59d1afc184a119057bd42cba948a1722;
