...
let
  sources = rec {
    phidgets_analog_outputs-f515b9e4933159442a9fc7e3004abd5b1896f1eb = substituteSource {
      src = fetchgit {
        name = "phidgets_analog_outputs-f515b9e4933159442a9fc7e3004abd5b1896f1eb-source";
...
buildRosPackage {
  ...
  version = "2.3.3-2";
  src = sources.phidgets_analog_outputs-f515b9e4933159442a9fc7e3004abd5b1896f1eb;
