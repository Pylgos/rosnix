...
let
  sources = rec {
    turtlebot4_viz-3c98949db94bbc3bd79210b1ff0d34845105f51d = substituteSource {
      src = fetchgit {
        name = "turtlebot4_viz-3c98949db94bbc3bd79210b1ff0d34845105f51d-source";
...
buildRosPackage {
  ...
  version = "2.0.1-1";
  src = sources.turtlebot4_viz-3c98949db94bbc3bd79210b1ff0d34845105f51d;
