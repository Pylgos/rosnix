...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ abseil-cpp cartographer cartographer_ros cartographer_ros_msgs pluginlib python3Packages.boost rclcpp rviz_common rviz_ogre_vendor rviz_rendering ];
  depsTargetTarget = [  ];
