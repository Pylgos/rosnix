...
let
  sources = rec {
    smach_ros-d16b3bef96ff7b3cac35e8f8ec771f6503498842 = substituteSource {
      src = fetchgit {
        name = "smach_ros-d16b3bef96ff7b3cac35e8f8ec771f6503498842-source";
...
buildRosPackage {
  pname = "smach_ros";
  version = "3.0.3-3";
  src = sources.smach_ros-d16b3bef96ff7b3cac35e8f8ec771f6503498842;
