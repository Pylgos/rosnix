...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ class_loader geometric_shapes interactive_markers moveit_common moveit_ros_planning_interface moveit_ros_robot_interaction moveit_ros_warehouse object_recognition_msgs pluginlib qt5.qtbase rclcpp rclpy rviz2 tf2_eigen ];
  depsTargetTarget = [  ];
