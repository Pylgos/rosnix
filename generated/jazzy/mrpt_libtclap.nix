  ...
  sources = rec {
    ...
    mrpt_libtclap = substituteSource {
      src = fetchgit {
        ...
        rev = "6ec5f22caccb2e3b22d71bc247d6832cce7bac50";
        hash = "sha256-Qc7zHzSTat4KlusTdCNNTSKQBuTcujVdXMJXUF3MO+s=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 opencv python3Packages.pip rclcpp rosbag2_storage suitesparse tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
