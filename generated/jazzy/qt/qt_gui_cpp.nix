...
let
  sources = rec {
    qt_gui_cpp-08b713a20f93a00a1453852534c6cf503140913b = substituteSource {
      src = fetchgit {
        name = "qt_gui_cpp-08b713a20f93a00a1453852534c6cf503140913b-source";
...
buildRosPackage {
  pname = "qt_gui_cpp";
  version = "2.7.4-2";
  src = sources.qt_gui_cpp-08b713a20f93a00a1453852534c6cf503140913b;
