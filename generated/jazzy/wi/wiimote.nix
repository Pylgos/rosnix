...
let
  sources = rec {
    wiimote-511ae4275bf3980a65c8af0f85f1e07748487b7e = substituteSource {
      src = fetchgit {
        name = "wiimote-511ae4275bf3980a65c8af0f85f1e07748487b7e-source";
...
buildRosPackage {
  pname = "wiimote";
  version = "3.3.0-3";
  src = sources.wiimote-511ae4275bf3980a65c8af0f85f1e07748487b7e;
