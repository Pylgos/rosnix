...
let
  sources = rec {
    diff_drive_controller-e4c38d5f650209c0ae89269a53fb5dfe3292ece4 = substituteSource {
      src = fetchgit {
        name = "diff_drive_controller-e4c38d5f650209c0ae89269a53fb5dfe3292ece4-source";
...
buildRosPackage {
  ...
  version = "4.14.0-1";
  src = sources.diff_drive_controller-e4c38d5f650209c0ae89269a53fb5dfe3292ece4;
