...
let
  sources = rec {
    gps_umd-ff0f9cdec7713df9990a4d9ed38373f80998f00e = substituteSource {
      src = fetchgit {
        name = "gps_umd-ff0f9cdec7713df9990a4d9ed38373f80998f00e-source";
...
buildRosPackage {
  pname = "gps_umd";
  version = "2.0.3-2";
  src = sources.gps_umd-ff0f9cdec7713df9990a4d9ed38373f80998f00e;
