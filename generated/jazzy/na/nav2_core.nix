...
let
  sources = rec {
    nav2_core-2bb7cc18fa14eb0095ac2e25a8cdbb9a4dbe730e = substituteSource {
      src = fetchgit {
        name = "nav2_core-2bb7cc18fa14eb0095ac2e25a8cdbb9a4dbe730e-source";
...
buildRosPackage {
  pname = "nav2_core";
  version = "1.3.2-1";
  src = sources.nav2_core-2bb7cc18fa14eb0095ac2e25a8cdbb9a4dbe730e;
