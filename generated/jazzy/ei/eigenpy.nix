...
let
  sources = rec {
    eigenpy-a7fcfca7312d7d98686fce1b2b23b9b5af161e46 = substituteSource {
      src = fetchgit {
        name = "eigenpy-a7fcfca7312d7d98686fce1b2b23b9b5af161e46-source";
...
buildRosPackage {
  pname = "eigenpy";
  version = "3.8.2-1";
  src = sources.eigenpy-a7fcfca7312d7d98686fce1b2b23b9b5af161e46;
