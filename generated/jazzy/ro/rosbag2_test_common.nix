...
let
  sources = rec {
    rosbag2_test_common-fe4cc460a8d58a78be4f5d2401bca9eaa3dfa249 = substituteSource {
      src = fetchgit {
        name = "rosbag2_test_common-fe4cc460a8d58a78be4f5d2401bca9eaa3dfa249-source";
...
buildRosPackage {
  ...
  version = "0.26.5-1";
  src = sources.rosbag2_test_common-fe4cc460a8d58a78be4f5d2401bca9eaa3dfa249;
