...
let
  sources = rec {
    rosbag2-6bbe7cbaacd88e781e2e223b7cfdbef67fd05716 = substituteSource {
      src = fetchgit {
        name = "rosbag2-6bbe7cbaacd88e781e2e223b7cfdbef67fd05716-source";
...
buildRosPackage {
  pname = "rosbag2";
  version = "0.26.5-1";
  src = sources.rosbag2-6bbe7cbaacd88e781e2e223b7cfdbef67fd05716;
