  ...
  sources = rec {
    ...
    mrpt_libopengl = substituteSource {
      src = fetchgit {
        ...
        rev = "e68e070c20eb24e8db40d22b2838dde387379677";
        hash = "sha256-8jiNluSaT1i5SbeT6ruckO76xx8fXQFWgeCCJYOlLxk=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libbase mrpt_libposes opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
