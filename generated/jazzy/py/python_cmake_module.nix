...
let
  sources = rec {
    python_cmake_module-52f6dbc990f7a89ceb09ab0cc394cc7214138f62 = substituteSource {
      src = fetchgit {
        name = "python_cmake_module-52f6dbc990f7a89ceb09ab0cc394cc7214138f62-source";
...
buildRosPackage {
  ...
  version = "0.11.1-2";
  src = sources.python_cmake_module-52f6dbc990f7a89ceb09ab0cc394cc7214138f62;
