...
let
  sources = rec {
    ublox_msgs-81c2cba3a487d742189f3022efc01fb794ef7034 = substituteSource {
      src = fetchgit {
        name = "ublox_msgs-81c2cba3a487d742189f3022efc01fb794ef7034-source";
...
buildRosPackage {
  pname = "ublox_msgs";
  version = "2.3.0-4";
  src = sources.ublox_msgs-81c2cba3a487d742189f3022efc01fb794ef7034;
