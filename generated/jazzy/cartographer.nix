...
buildRosPackage {
  ...
  propagatedNativeBuildInputs = [ eigen git gtest ];
  buildInputs = [  ];
  propagatedBuildInputs = [ abseil-cpp cairo ceres-solver gflags glog lua5 protobuf python3Packages.boost python3Packages.sphinx ];
  depsTargetTarget = [  ];
