...
let
  sources = rec {
    ...
    hash_library_vendor-cd243a064b6da2fcbd714575e2dd3d6158af7901 = substituteSource {
      src = fetchgit {
        name = "hash_library_vendor-cd243a064b6da2fcbd714575e2dd3d6158af7901-source";
...
buildRosPackage {
  ...
  version = "0.1.1-7";
  src = sources.hash_library_vendor-cd243a064b6da2fcbd714575e2dd3d6158af7901;
