  ...
  sources = rec {
    ...
    mrpt_apps = substituteSource {
      src = fetchgit {
        ...
        rev = "c11a59d3901db5ba80a3b2d22562eb219aeac15a";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libapps mrpt_libnav opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
