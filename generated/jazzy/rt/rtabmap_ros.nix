...
let
  sources = rec {
    rtabmap_ros-0657471e1353d3541447a2cc2b00271aaf695972 = substituteSource {
      src = fetchgit {
        name = "rtabmap_ros-0657471e1353d3541447a2cc2b00271aaf695972-source";
...
buildRosPackage {
  pname = "rtabmap_ros";
  version = "0.21.5-3";
  src = sources.rtabmap_ros-0657471e1353d3541447a2cc2b00271aaf695972;
