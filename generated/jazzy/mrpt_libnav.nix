  ...
  sources = rec {
    ...
    mrpt_libnav = substituteSource {
      src = fetchgit {
        ...
        rev = "b1f6ae145583642cbb4f5e8660ad90d0977de1a0";
        hash = "sha256-6C8AcGOHm2O6XPfEP6I7qY0wu0oz6jfrnWrBzkr7bTA=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libmaps opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
