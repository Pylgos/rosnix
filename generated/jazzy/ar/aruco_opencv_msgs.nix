...
let
  sources = rec {
    aruco_opencv_msgs-c4ff2411a22a0916f08ff933eb620d58beecf73b = substituteSource {
      src = fetchgit {
        name = "aruco_opencv_msgs-c4ff2411a22a0916f08ff933eb620d58beecf73b-source";
...
buildRosPackage {
  ...
  version = "6.0.1-1";
  src = sources.aruco_opencv_msgs-c4ff2411a22a0916f08ff933eb620d58beecf73b;
