...
let
  sources = rec {
    simple_term_menu_vendor-6ab8fbe31338a72360563ee2b2f44ba1512e745d = substituteSource {
      src = fetchgit {
        name = "simple_term_menu_vendor-6ab8fbe31338a72360563ee2b2f44ba1512e745d-source";
...
buildRosPackage {
  ...
  version = "1.5.7-1";
  src = sources.simple_term_menu_vendor-6ab8fbe31338a72360563ee2b2f44ba1512e745d;
