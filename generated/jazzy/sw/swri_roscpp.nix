...
let
  sources = rec {
    swri_roscpp-1364a7e867301fe06b040bd24fa55670f87f2557 = substituteSource {
      src = fetchgit {
        name = "swri_roscpp-1364a7e867301fe06b040bd24fa55670f87f2557-source";
...
buildRosPackage {
  pname = "swri_roscpp";
  version = "3.7.3-1";
  src = sources.swri_roscpp-1364a7e867301fe06b040bd24fa55670f87f2557;
