...
let
  sources = rec {
    rc_dynamics_api-adad10c595a8e0dae8721169740ac3480df23496 = substituteSource {
      src = fetchgit {
        name = "rc_dynamics_api-adad10c595a8e0dae8721169740ac3480df23496-source";
...
buildRosPackage {
  ...
  version = "0.10.5-2";
  src = sources.rc_dynamics_api-adad10c595a8e0dae8721169740ac3480df23496;
