...
let
  sources = rec {
    lanelet2_io-3a62e4d061574a0d62757874c354ffaf6e3a4128 = substituteSource {
      src = fetchgit {
        name = "lanelet2_io-3a62e4d061574a0d62757874c354ffaf6e3a4128-source";
...
buildRosPackage {
  pname = "lanelet2_io";
  version = "1.2.1-1";
  src = sources.lanelet2_io-3a62e4d061574a0d62757874c354ffaf6e3a4128;
