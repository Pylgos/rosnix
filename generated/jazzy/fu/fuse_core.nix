...
let
  sources = rec {
    fuse_core-b3b1cb3f75ff1d3fa4e45646dbdbf24f5497857b = substituteSource {
      src = fetchgit {
        name = "fuse_core-b3b1cb3f75ff1d3fa4e45646dbdbf24f5497857b-source";
...
buildRosPackage {
  pname = "fuse_core";
  version = "1.1.1-1";
  src = sources.fuse_core-b3b1cb3f75ff1d3fa4e45646dbdbf24f5497857b;
