...
let
  sources = rec {
    moveit_core-4ddbf0913eeb711c68b916e71d92c144500892da = substituteSource {
      src = fetchgit {
        name = "moveit_core-4ddbf0913eeb711c68b916e71d92c144500892da-source";
...
buildRosPackage {
  pname = "moveit_core";
  version = "2.10.0-1";
  src = sources.moveit_core-4ddbf0913eeb711c68b916e71d92c144500892da;
