...
let
  sources = rec {
    moveit_ros-892a548c79100fe246e5230d1a4319cc0b1222a6 = substituteSource {
      src = fetchgit {
        name = "moveit_ros-892a548c79100fe246e5230d1a4319cc0b1222a6-source";
...
buildRosPackage {
  pname = "moveit_ros";
  version = "2.10.0-1";
  src = sources.moveit_ros-892a548c79100fe246e5230d1a4319cc0b1222a6;
