...
let
  sources = rec {
    moveit_msgs-1225bd68c7aaae83a9d763303e0b2ac909b3062a = substituteSource {
      src = fetchgit {
        name = "moveit_msgs-1225bd68c7aaae83a9d763303e0b2ac909b3062a-source";
...
buildRosPackage {
  pname = "moveit_msgs";
  version = "2.5.0-1";
  src = sources.moveit_msgs-1225bd68c7aaae83a9d763303e0b2ac909b3062a;
