...
let
  sources = rec {
    cartographer_rviz-c0528e46728174c2c4893a6bbf43fe87ba86f2e5 = substituteSource {
      src = fetchgit {
        name = "cartographer_rviz-c0528e46728174c2c4893a6bbf43fe87ba86f2e5-source";
...
buildRosPackage {
  ...
  version = "2.0.9003-2";
  src = sources.cartographer_rviz-c0528e46728174c2c4893a6bbf43fe87ba86f2e5;
