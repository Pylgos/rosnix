...
let
  sources = rec {
    rmf_websocket-cca3b39018221e53345b0f5755d9c021a86b164b = substituteSource {
      src = fetchgit {
        name = "rmf_websocket-cca3b39018221e53345b0f5755d9c021a86b164b-source";
...
buildRosPackage {
  pname = "rmf_websocket";
  version = "2.7.2-1";
  src = sources.rmf_websocket-cca3b39018221e53345b0f5755d9c021a86b164b;
