...
let
  sources = rec {
    ament_cmake_clang_tidy-562390b923d85145a6adf9531e3a9f3a9e2422a4 = substituteSource {
      src = fetchgit {
        name = "ament_cmake_clang_tidy-562390b923d85145a6adf9531e3a9f3a9e2422a4-source";
...
buildRosPackage {
  ...
  version = "0.17.1-1";
  src = sources.ament_cmake_clang_tidy-562390b923d85145a6adf9531e3a9f3a9e2422a4;
