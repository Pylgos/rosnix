...
let
  sources = rec {
    sros2-3a92a9b9cc2f7dcf45cb81837d02f4bd4b1025d5 = substituteSource {
      src = fetchgit {
        name = "sros2-3a92a9b9cc2f7dcf45cb81837d02f4bd4b1025d5-source";
...
buildRosPackage {
  pname = "sros2";
  version = "0.13.2-1";
  src = sources.sros2-3a92a9b9cc2f7dcf45cb81837d02f4bd4b1025d5;
