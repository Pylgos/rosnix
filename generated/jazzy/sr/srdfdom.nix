...
let
  sources = rec {
    srdfdom-6817f4b07d5c39f06de2a713efb0b3264e8cb10c = substituteSource {
      src = fetchgit {
        name = "srdfdom-6817f4b07d5c39f06de2a713efb0b3264e8cb10c-source";
...
buildRosPackage {
  pname = "srdfdom";
  version = "2.0.4-4";
  src = sources.srdfdom-6817f4b07d5c39f06de2a713efb0b3264e8cb10c;
