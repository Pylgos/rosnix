...
let
  sources = rec {
    ...
    openeb_vendor-03acbfa67f03718ce8510153b12df88045ab2e0b = substituteSource {
      src = fetchgit {
        name = "openeb_vendor-03acbfa67f03718ce8510153b12df88045ab2e0b-source";
...
buildRosPackage {
  pname = "openeb_vendor";
  version = "2.0.0-1";
  src = sources.openeb_vendor-03acbfa67f03718ce8510153b12df88045ab2e0b;
