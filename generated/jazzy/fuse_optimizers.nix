...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ ceres-solver diagnostic_updater fuse_constraints fuse_core fuse_graphs fuse_msgs fuse_variables pluginlib python3Packages.boost rclcpp rclcpp_components std_srvs ];
  depsTargetTarget = [  ];
