...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ class_loader generate_parameter_library moveit_common moveit_core moveit_msgs moveit_ros_planning orocos_kdl_vendor pluginlib python3Packages.lxml rsl tf2 tf2_kdl urdfdom ];
  depsTargetTarget = [  ];
