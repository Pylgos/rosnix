  ...
  sources = rec {
    ...
    mrpt_libposes = substituteSource {
      src = fetchgit {
        ...
        rev = "ac5116a1944ef3384330beb3d0c286eb3a78e999";
        hash = "sha256-G4zk6/VwAi5tk8UA3Qii6Ib3Rbkci1/8aJDqt5XVEUQ=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libbase mrpt_libmath opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
