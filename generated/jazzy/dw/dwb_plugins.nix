...
let
  sources = rec {
    dwb_plugins-b30a9ef44cf345835dc994d94a6df82cc7439ed7 = substituteSource {
      src = fetchgit {
        name = "dwb_plugins-b30a9ef44cf345835dc994d94a6df82cc7439ed7-source";
...
buildRosPackage {
  pname = "dwb_plugins";
  version = "1.3.2-1";
  src = sources.dwb_plugins-b30a9ef44cf345835dc994d94a6df82cc7439ed7;
