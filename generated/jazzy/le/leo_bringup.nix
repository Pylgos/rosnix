...
let
  sources = rec {
    leo_bringup-73eab93f993751eacc4c6948077b6de916f7ff57 = substituteSource {
      src = fetchgit {
        name = "leo_bringup-73eab93f993751eacc4c6948077b6de916f7ff57-source";
...
buildRosPackage {
  pname = "leo_bringup";
  version = "1.4.0-3";
  src = sources.leo_bringup-73eab93f993751eacc4c6948077b6de916f7ff57;
