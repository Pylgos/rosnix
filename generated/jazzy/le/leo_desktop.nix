...
let
  sources = rec {
    leo_desktop-c1a54f9b40ddbf3bc97fee01d5c59273e6dde297 = substituteSource {
      src = fetchgit {
        name = "leo_desktop-c1a54f9b40ddbf3bc97fee01d5c59273e6dde297-source";
...
buildRosPackage {
  pname = "leo_desktop";
  version = "3.0.0-3";
  src = sources.leo_desktop-c1a54f9b40ddbf3bc97fee01d5c59273e6dde297;
