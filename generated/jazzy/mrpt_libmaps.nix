  ...
  sources = rec {
    ...
    mrpt_libmaps = substituteSource {
      src = fetchgit {
        ...
        rev = "e775886725186203da3f3a1fad53e93affbbb349";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libobs opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
