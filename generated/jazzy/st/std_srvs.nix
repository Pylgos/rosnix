...
let
  sources = rec {
    std_srvs-8fc86bed667466d9fc6f8d56c36be60bcc6f59f2 = substituteSource {
      src = fetchgit {
        name = "std_srvs-8fc86bed667466d9fc6f8d56c36be60bcc6f59f2-source";
...
buildRosPackage {
  pname = "std_srvs";
  version = "5.3.5-1";
  src = sources.std_srvs-8fc86bed667466d9fc6f8d56c36be60bcc6f59f2;
