  ...
  sources = rec {
    ...
    mrpt_libobs = substituteSource {
      src = fetchgit {
        ...
        rev = "4c5d13a8315a6ca77607f3cdf8dde1b262007acb";
        hash = "sha256-IpScdERYgFuMQuTLVkvydoA2IAkxa9uWmKsoLu6PKEM=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ assimp cv_bridge ffmpeg freeglut freenect glfw3 libGL libGLU libjpeg libpcap libusb1 mrpt_libopengl mrpt_libposes opencv python3Packages.pip rclcpp rosbag2_storage tinyxml-2 udev wxGTK32 xorg.libXrandr zlib ];
  depsTargetTarget = [  ];
