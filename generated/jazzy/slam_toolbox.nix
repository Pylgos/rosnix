...
buildRosPackage {
  ...
  buildInputs = [  ];
  propagatedBuildInputs = [ bond bondcpp builtin_interfaces ceres-solver interactive_markers liblapack lifecycle_msgs message_filters nav_msgs pluginlib python3Packages.boost qt5.qtbase rclcpp rclcpp_lifecycle rviz_common rviz_default_plugins rviz_ogre_vendor rviz_rendering sensor_msgs std_msgs std_srvs suitesparse tbb tf2 tf2_geometry_msgs tf2_ros tf2_sensor_msgs visualization_msgs ];
  depsTargetTarget = [  ];
