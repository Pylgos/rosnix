...
let
  sources = rec {
    snowbot_operating_system-df8b6b2679855c245fb9cb9e6f80612438815599 = substituteSource {
      src = fetchgit {
        name = "snowbot_operating_system-df8b6b2679855c245fb9cb9e6f80612438815599-source";
...
buildRosPackage {
  ...
  version = "0.1.2-5";
  src = sources.snowbot_operating_system-df8b6b2679855c245fb9cb9e6f80612438815599;
