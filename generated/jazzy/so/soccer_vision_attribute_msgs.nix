...
let
  sources = rec {
    soccer_vision_attribute_msgs-f44eead2de262caf02988809719f54cf89f5d8d7 = substituteSource {
      src = fetchgit {
        name = "soccer_vision_attribute_msgs-f44eead2de262caf02988809719f54cf89f5d8d7-source";
...
buildRosPackage {
  ...
  version = "1.0.0-2";
  src = sources.soccer_vision_attribute_msgs-f44eead2de262caf02988809719f54cf89f5d8d7;
