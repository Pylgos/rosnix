...
let
  sources = rec {
    mrpt_libopengl-2d3db18eff5f7edc5ab7e33f8f7b08d52de120e5 = substituteSource {
      src = fetchgit {
        name = "mrpt_libopengl-2d3db18eff5f7edc5ab7e33f8f7b08d52de120e5-source";
...
buildRosPackage {
  ...
  version = "2.14.1-1";
  src = sources.mrpt_libopengl-2d3db18eff5f7edc5ab7e33f8f7b08d52de120e5;
