...
let
  sources = rec {
    mrpt_apps-0080d083505c9907343bbfaa4a1ca3307437bf04 = substituteSource {
      src = fetchgit {
        name = "mrpt_apps-0080d083505c9907343bbfaa4a1ca3307437bf04-source";
...
buildRosPackage {
  pname = "mrpt_apps";
  version = "2.14.1-1";
  src = sources.mrpt_apps-0080d083505c9907343bbfaa4a1ca3307437bf04;
