...
let
  sources = rec {
    bond-ef14f8df594843cad635278c35a496bc76cf3e06 = substituteSource {
      src = fetchgit {
        name = "bond-ef14f8df594843cad635278c35a496bc76cf3e06-source";
...
buildRosPackage {
  pname = "bond";
  version = "4.1.0-1";
  src = sources.bond-ef14f8df594843cad635278c35a496bc76cf3e06;
