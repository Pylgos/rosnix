...
let
  sources = rec {
    intra_process_demo-18ef1bbb1f02523801ab16ebc13d7ef70aeb3af7 = substituteSource {
      src = fetchgit {
        name = "intra_process_demo-18ef1bbb1f02523801ab16ebc13d7ef70aeb3af7-source";
...
buildRosPackage {
  ...
  version = "0.33.5-1";
  src = sources.intra_process_demo-18ef1bbb1f02523801ab16ebc13d7ef70aeb3af7;
