...
let
  sources = rec {
    flexbe_core-237e2098a1e767209cf6aa0806947e9d68ae024c = substituteSource {
      src = fetchgit {
        name = "flexbe_core-237e2098a1e767209cf6aa0806947e9d68ae024c-source";
...
buildRosPackage {
  pname = "flexbe_core";
  version = "3.0.3-1";
  src = sources.flexbe_core-237e2098a1e767209cf6aa0806947e9d68ae024c;
