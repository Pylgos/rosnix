...
let
  sources = rec {
    flexbe_widget-ce31f66657d5a4e49e0842f6915ae5a51baca4d5 = substituteSource {
      src = fetchgit {
        name = "flexbe_widget-ce31f66657d5a4e49e0842f6915ae5a51baca4d5-source";
...
buildRosPackage {
  pname = "flexbe_widget";
  version = "3.0.3-1";
  src = sources.flexbe_widget-ce31f66657d5a4e49e0842f6915ae5a51baca4d5;
