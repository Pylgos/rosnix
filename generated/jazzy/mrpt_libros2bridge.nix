...
let
  sources = rec {
    ...
    mrpt_libros2bridge = substituteSource {
      src = fetchgit {
        name = "mrpt_libros2bridge-source";
        url = "https://github.com/ros2-gbp/mrpt_ros-release.git";
        rev = "754d0aaaec1cd493548fac2d2b65364bb1c4dff5";
        hash = "sha256-f+UdsnmrGqAxoosLd+iiH+2vvfs3K4Vqbb11PoxPp5k=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
...
in
buildRosPackage {
  pname = "mrpt_libros2bridge";
  version = "2.13.6-3";
  src = sources.mrpt_libros2bridge;
