...
let
  sources = rec {
    tile_map-73ecd90d1cab837ad85ab51c5ef346339c19599a = substituteSource {
      src = fetchgit {
        name = "tile_map-73ecd90d1cab837ad85ab51c5ef346339c19599a-source";
...
buildRosPackage {
  pname = "tile_map";
  version = "2.4.3-1";
  src = sources.tile_map-73ecd90d1cab837ad85ab51c5ef346339c19599a;
