...
let
  sources = rec {
    ecl_sigslots_lite-5ef1635c1eef70e7fa3bb94f07a43adf19806042 = substituteSource {
      src = fetchgit {
        name = "ecl_sigslots_lite-5ef1635c1eef70e7fa3bb94f07a43adf19806042-source";
...
buildRosPackage {
  ...
  version = "1.2.0-5";
  src = sources.ecl_sigslots_lite-5ef1635c1eef70e7fa3bb94f07a43adf19806042;
