...
let
  sources = rec {
    ecl_time_lite-e01d6ea66feaa66afcb6351f65934b129fd692fb = substituteSource {
      src = fetchgit {
        name = "ecl_time_lite-e01d6ea66feaa66afcb6351f65934b129fd692fb-source";
...
buildRosPackage {
  pname = "ecl_time_lite";
  version = "1.2.0-5";
  src = sources.ecl_time_lite-e01d6ea66feaa66afcb6351f65934b129fd692fb;
