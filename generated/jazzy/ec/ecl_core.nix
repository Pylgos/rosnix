...
let
  sources = rec {
    ecl_core-46da871000a3a83679269de8f8c116e49f5403a0 = substituteSource {
      src = fetchgit {
        name = "ecl_core-46da871000a3a83679269de8f8c116e49f5403a0-source";
...
buildRosPackage {
  pname = "ecl_core";
  version = "1.2.1-5";
  src = sources.ecl_core-46da871000a3a83679269de8f8c116e49f5403a0;
