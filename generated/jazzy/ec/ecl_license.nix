...
let
  sources = rec {
    ecl_license-6cac334990aa3f48432e60c033a56aa590a79261 = substituteSource {
      src = fetchgit {
        name = "ecl_license-6cac334990aa3f48432e60c033a56aa590a79261-source";
...
buildRosPackage {
  pname = "ecl_license";
  version = "1.0.3-5";
  src = sources.ecl_license-6cac334990aa3f48432e60c033a56aa590a79261;
