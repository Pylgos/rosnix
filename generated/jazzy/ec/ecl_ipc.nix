...
let
  sources = rec {
    ecl_ipc-591c2d181016f5c4ea267c904d7da916fd09074a = substituteSource {
      src = fetchgit {
        name = "ecl_ipc-591c2d181016f5c4ea267c904d7da916fd09074a-source";
...
buildRosPackage {
  pname = "ecl_ipc";
  version = "1.2.1-5";
  src = sources.ecl_ipc-591c2d181016f5c4ea267c904d7da916fd09074a;
