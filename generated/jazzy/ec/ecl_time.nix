...
let
  sources = rec {
    ecl_time-737c5377306d2ab352553b7abac2e223d197c918 = substituteSource {
      src = fetchgit {
        name = "ecl_time-737c5377306d2ab352553b7abac2e223d197c918-source";
...
buildRosPackage {
  pname = "ecl_time";
  version = "1.2.1-5";
  src = sources.ecl_time-737c5377306d2ab352553b7abac2e223d197c918;
