...
buildAmentCmakePackage (finalAttrs: {
  ...
  checkInputs = [ ament-cmake-pytest ament-index-python ament-lint-auto launch launch-testing ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "python-attrs-pip" "python-numpy-quaternion-pip" "python3-pytest" ]; };
  passthru.sources = mkSourceSet (sources: {
    "automatika_ros_sugar" = substituteSource {
      src = fetchgit {
        ...
        rev = "5a6f5d577362c293a5c2aa128250750f26b5a8f0";
        hash = "sha256-7vhiKtLjij9Igu5sgT4FNujVrBI9hGLweOA6SVlbPG0=";
      };
    };
  });
  meta = {
