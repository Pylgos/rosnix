  ...
  passthru.sources = mkSourceSet (sources: {
    "gz_sim_vendor" = substituteSource {
      src = fetchgit {
        ...
        rev = "b66c83a0d06983cc72d02674de04e16f8829a43d";
        hash = "sha256-FiD1use6rqHJfJIiyTHc78PK7akKszT7y/i3NObazBo=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "gz_sim_vendor/gz-sim" = substituteSource {
      src = fetchgit {
        ...
        rev = "f986646def8047bd0690d364f31f8dc9b1af9dc1";
        hash = "sha256-ciOUAz6ziIcN9CYG3R2JYtcH14KiCGjMwiKSlOev39Q=";
      };
    };
  });
  meta = {
    description = "\n    Vendor package for: gz-sim8 8.10.0\n\n    Gazebo Sim : A Robotic Simulator\n  ";
  };
})
