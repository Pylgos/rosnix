  ...
  passthru.sources = mkSourceSet (sources: {
    "gz_sim_vendor" = substituteSource {
      src = fetchgit {
        ...
        rev = "ec76d8280b67abe8c3e7a8463b72b5ba0f779865";
        hash = "sha256-1yiKOWCvKQUmFLOjybtJPgqi3JNWbFLkwDBJNUYNJZo=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "gz_sim_vendor/gz-sim" = substituteSource {
      src = fetchgit {
        ...
        rev = "1be3cc376fec778cc725b4eeea463245affa56d3";
        hash = "sha256-gn7UymNuR3Ih9d/xetXKa0LKuIu/MeKX7KsNCU16nto=";
      };
    };
  });
  meta = {
    description = "\n    Vendor package for: gz-sim8 8.11.0\n\n    Gazebo Sim : A Robotic Simulator\n  ";
  };
})
