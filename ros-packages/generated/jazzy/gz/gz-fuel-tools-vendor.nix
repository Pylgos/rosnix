...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ gz-common-vendor gz-math-vendor gz-msgs-vendor gz-tools-vendor gz-utils-vendor ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "gz-fuel_tools9" "libcurl-dev" "libgflags-dev" "libjsoncpp-dev" "libzip-dev" "tinyxml2" ]; };
