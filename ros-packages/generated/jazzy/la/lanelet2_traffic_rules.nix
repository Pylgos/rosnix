...
let
  sources = rec {
    lanelet2_traffic_rules-cab3d2d9315ab49c368620eae99f38e406d1463c = substituteSource {
      src = fetchgit {
        name = "lanelet2_traffic_rules-cab3d2d9315ab49c368620eae99f38e406d1463c-source";
...
buildRosPackage {
  ...
  version = "1.2.1-1";
  src = sources.lanelet2_traffic_rules-cab3d2d9315ab49c368620eae99f38e406d1463c;
