...
let
  sources = rec {
    polygon_utils-32a840fb29275dcf540d8b14c28997d06756c144 = substituteSource {
      src = fetchgit {
        name = "polygon_utils-32a840fb29275dcf540d8b14c28997d06756c144-source";
...
buildRosPackage {
  pname = "polygon_utils";
  version = "1.1.0-1";
  src = sources.polygon_utils-32a840fb29275dcf540d8b14c28997d06756c144;
