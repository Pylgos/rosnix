...
let
  sources = rec {
    point_cloud_transport_plugins-c18782cb6ee32f7c17638656243c5771d8ad8d64 = substituteSource {
      src = fetchgit {
        name = "point_cloud_transport_plugins-c18782cb6ee32f7c17638656243c5771d8ad8d64-source";
...
buildRosPackage {
  ...
  version = "4.0.1-1";
  src = sources.point_cloud_transport_plugins-c18782cb6ee32f7c17638656243c5771d8ad8d64;
