...
let
  sources = rec {
    image_view-3421ca8f0da7cf0d33b8a11f27827498969623de = substituteSource {
      src = fetchgit {
        name = "image_view-3421ca8f0da7cf0d33b8a11f27827498969623de-source";
...
buildRosPackage {
  pname = "image_view";
  version = "5.0.4-1";
  src = sources.image_view-3421ca8f0da7cf0d33b8a11f27827498969623de;
