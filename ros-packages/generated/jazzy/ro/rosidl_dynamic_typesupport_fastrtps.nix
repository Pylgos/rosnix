...
let
  sources = rec {
    rosidl_dynamic_typesupport_fastrtps-700363b667895d30d6670e3e097623462f34cc41 = substituteSource {
      src = fetchgit {
        name = "rosidl_dynamic_typesupport_fastrtps-700363b667895d30d6670e3e097623462f34cc41-source";
...
buildRosPackage {
  ...
  version = "0.1.0-3";
  src = sources.rosidl_dynamic_typesupport_fastrtps-700363b667895d30d6670e3e097623462f34cc41;
