...
let
  sources = rec {
    ...
    python_mrpt-67827d82701c797f844726bdad13d3bee467d740 = substituteSource {
      src = fetchgit {
        name = "python_mrpt-67827d82701c797f844726bdad13d3bee467d740-source";
...
buildRosPackage {
  pname = "python_mrpt";
  version = "2.14.1-1";
  src = sources.python_mrpt-67827d82701c797f844726bdad13d3bee467d740;
