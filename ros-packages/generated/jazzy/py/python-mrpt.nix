  ...
  passthru.sources = mkSourceSet (sources: {
    "python_mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "f816af8cf127c85df80a9d4929a4f1be245c4bd0";
        hash = "sha256-MAyZcTRIiVgQSP4xVmQ9Dvg7eKhss2B3Hl1vucCCe9k=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "python_mrpt/mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "07783e5cf7ede5dfc4a0c9358017c4cc9b923771";
        hash = "sha256-O5tMQQ2s2YOUI+xH082t5S7MD8UYOgcoResIrBJcozY=";
      };
      substitutions = [
        {
