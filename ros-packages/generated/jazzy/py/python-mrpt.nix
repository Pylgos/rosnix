  ...
  passthru.sources = mkSourceSet (sources: {
    "python_mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "6696f302212bc7a96cb215de70a424022822849a";
        hash = "sha256-Zm47pFLC8itIGUqydSM//kBBq4eiJsAa499zfeGQf24=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "python_mrpt/mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "58a57e94c79cd7ff4c0fb119d4cf192fb2c765d3";
        hash = "sha256-F4g2phk349aPMvz7G5Km68fjg4DiIvU+XPuJX89BhsI=";
      };
      substitutions = [
        {
