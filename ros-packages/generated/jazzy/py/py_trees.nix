...
let
  sources = rec {
    py_trees-6aa58f8414fb672071074c6d4621c3ca8968488f = substituteSource {
      src = fetchgit {
        name = "py_trees-6aa58f8414fb672071074c6d4621c3ca8968488f-source";
...
buildRosPackage {
  pname = "py_trees";
  version = "2.2.1-4";
  src = sources.py_trees-6aa58f8414fb672071074c6d4621c3ca8968488f;
