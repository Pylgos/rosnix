...
let
  sources = rec {
    tango_icons_vendor-f39545a4d833fdda28ad1458496129de949c59d8 = substituteSource {
      src = fetchgit {
        name = "tango_icons_vendor-f39545a4d833fdda28ad1458496129de949c59d8-source";
...
buildRosPackage {
  ...
  version = "0.3.0-3";
  src = sources.tango_icons_vendor-f39545a4d833fdda28ad1458496129de949c59d8;
