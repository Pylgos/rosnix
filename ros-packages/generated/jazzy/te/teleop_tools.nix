...
let
  sources = rec {
    teleop_tools-b40af35d16c14c6d912ff5e7b9420747ea8bf186 = substituteSource {
      src = fetchgit {
        name = "teleop_tools-b40af35d16c14c6d912ff5e7b9420747ea8bf186-source";
...
buildRosPackage {
  pname = "teleop_tools";
  version = "1.5.1-1";
  src = sources.teleop_tools-b40af35d16c14c6d912ff5e7b9420747ea8bf186;
