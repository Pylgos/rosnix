...
let
  sources = rec {
    splsm_7-ad902c08fe13db07fdacf98d2f6e641fda5fea40 = substituteSource {
      src = fetchgit {
        name = "splsm_7-ad902c08fe13db07fdacf98d2f6e641fda5fea40-source";
...
buildRosPackage {
  pname = "splsm_7";
  version = "3.0.1-4";
  src = sources.splsm_7-ad902c08fe13db07fdacf98d2f6e641fda5fea40;
