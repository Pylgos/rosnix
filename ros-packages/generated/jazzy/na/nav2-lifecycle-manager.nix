...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ bondcpp diagnostic-updater geometry-msgs lifecycle-msgs nav2-common nav2-msgs nav2-util rclcpp-action std-msgs std-srvs tf2-geometry-msgs ];
