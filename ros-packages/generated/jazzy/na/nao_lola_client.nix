...
let
  sources = rec {
    nao_lola_client-c81a45165ab9fa279a5a60509cf97db5c2a31b15 = substituteSource {
      src = fetchgit {
        name = "nao_lola_client-c81a45165ab9fa279a5a60509cf97db5c2a31b15-source";
...
buildRosPackage {
  ...
  version = "1.3.0-2";
  src = sources.nao_lola_client-c81a45165ab9fa279a5a60509cf97db5c2a31b15;
