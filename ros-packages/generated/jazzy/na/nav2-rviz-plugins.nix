  ...
  passthru.sources = mkSourceSet (sources: {
    "nav2_rviz_plugins" = substituteSource {
      src = fetchgit {
        ...
        rev = "86c5b56eac49b58fd6c1c95b9ca1fc97d4e40b84";
        hash = "sha256-Me6ebDQZdUXPv4CqmQQURqfnk6MjYe06Ae5OOTtTybQ=";
      };
    };
  });
  meta = {
