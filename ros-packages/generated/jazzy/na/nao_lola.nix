...
let
  sources = rec {
    nao_lola-8a20246aaa40a9b39b647fca378090da73caa4cc = substituteSource {
      src = fetchgit {
        name = "nao_lola-8a20246aaa40a9b39b647fca378090da73caa4cc-source";
...
buildRosPackage {
  pname = "nao_lola";
  version = "1.3.0-2";
  src = sources.nao_lola-8a20246aaa40a9b39b647fca378090da73caa4cc;
