...
let
  sources = rec {
    color_util-231c6ee5d3a4330fa1d39e1085f260961d1acaf9 = substituteSource {
      src = fetchgit {
        name = "color_util-231c6ee5d3a4330fa1d39e1085f260961d1acaf9-source";
...
buildRosPackage {
  pname = "color_util";
  version = "1.0.0-4";
  src = sources.color_util-231c6ee5d3a4330fa1d39e1085f260961d1acaf9;
