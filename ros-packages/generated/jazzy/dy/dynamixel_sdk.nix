...
let
  sources = rec {
    dynamixel_sdk-9ed7cf8e3a010569e4964bd0d3767b2cf30d6f64 = substituteSource {
      src = fetchgit {
        name = "dynamixel_sdk-9ed7cf8e3a010569e4964bd0d3767b2cf30d6f64-source";
...
buildRosPackage {
  pname = "dynamixel_sdk";
  version = "3.7.40-6";
  src = sources.dynamixel_sdk-9ed7cf8e3a010569e4964bd0d3767b2cf30d6f64;
