...
let
  sources = rec {
    fuse_models-4b3d2a3c62eda494d2a2dc9feb8d8bb73406c7f1 = substituteSource {
      src = fetchgit {
        name = "fuse_models-4b3d2a3c62eda494d2a2dc9feb8d8bb73406c7f1-source";
...
buildRosPackage {
  pname = "fuse_models";
  version = "1.1.1-1";
  src = sources.fuse_models-4b3d2a3c62eda494d2a2dc9feb8d8bb73406c7f1;
