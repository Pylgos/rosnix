...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ fuse-core fuse-graphs fuse-variables geometry-msgs pluginlib ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "libceres-dev" "suitesparse" ]; };
