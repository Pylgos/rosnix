...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ fastcdr fastrtps rcutils rmw rmw-dds-common rosidl-runtime-c rosidl-typesupport-introspection-c rosidl-typesupport-introspection-cpp ];
