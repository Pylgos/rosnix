...
let
  sources = rec {
    rmf_task-b42a6d47b406d4534212fd4bdce519fc6fc0ad7d = substituteSource {
      src = fetchgit {
        name = "rmf_task-b42a6d47b406d4534212fd4bdce519fc6fc0ad7d-source";
...
buildRosPackage {
  pname = "rmf_task";
  version = "2.5.1-1";
  src = sources.rmf_task-b42a6d47b406d4534212fd4bdce519fc6fc0ad7d;
