...
buildAmentPythonPackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ launch-xml rmf-fleet-adapter-python rmf-fleet-msgs rmf-task-msgs ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "python3-fastapi" "python3-flask-socketio" "python3-pydantic" "python3-pyproj" "python3-requests" "python3-uvicorn" ]; };
