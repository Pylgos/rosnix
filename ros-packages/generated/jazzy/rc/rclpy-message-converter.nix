...
buildAmentPythonPackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ rclpy rosidl-default-generators rosidl-parser ] ++ rosSystemPackages.getPackages { forNativeBuildInputs = [ "python3-numpy" ]; };
  propagatedBuildInputs = [ builtin-interfaces rosidl-runtime-py ];
