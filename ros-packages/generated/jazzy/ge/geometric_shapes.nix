...
let
  sources = rec {
    geometric_shapes-96327540c29c53b84b4d769295d2d3bfabb46144 = substituteSource {
      src = fetchgit {
        name = "geometric_shapes-96327540c29c53b84b4d769295d2d3bfabb46144-source";
...
buildRosPackage {
  ...
  version = "2.2.1-1";
  src = sources.geometric_shapes-96327540c29c53b84b4d769295d2d3bfabb46144;
