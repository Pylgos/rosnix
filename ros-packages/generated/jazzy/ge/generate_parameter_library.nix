...
let
  sources = rec {
    generate_parameter_library-9b3b5eadcc4de586ae0880f33293fc9d64022fea = substituteSource {
      src = fetchgit {
        name = "generate_parameter_library-9b3b5eadcc4de586ae0880f33293fc9d64022fea-source";
...
buildRosPackage {
  ...
  version = "0.3.8-4";
  src = sources.generate_parameter_library-9b3b5eadcc4de586ae0880f33293fc9d64022fea;
