...
let
  sources = rec {
    pcl_ros-4200ad2cd0685c607ff4c420e6825f5abeb5457c = substituteSource {
      src = fetchgit {
        name = "pcl_ros-4200ad2cd0685c607ff4c420e6825f5abeb5457c-source";
...
buildRosPackage {
  pname = "pcl_ros";
  version = "2.6.1-4";
  src = sources.pcl_ros-4200ad2cd0685c607ff4c420e6825f5abeb5457c;
