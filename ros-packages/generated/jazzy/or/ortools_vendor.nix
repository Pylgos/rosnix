...
let
  sources = rec {
    ...
    ortools_vendor-87e2a82f7ef8300503e749a1647146e94baff921 = substituteSource {
      src = fetchgit {
        name = "ortools_vendor-87e2a82f7ef8300503e749a1647146e94baff921-source";
      ...
      substitutions = [
        {
          ...
          to = "VCS_TYPE path VCS_URL ${or_tools-vendor_source-3c5c99c278ef3d0ac85cdbd4f008f8c0fd2f3f94}";
        }
      ];
    };
...
buildRosPackage {
  ...
  version = "9.9.0-6";
  src = sources.ortools_vendor-87e2a82f7ef8300503e749a1647146e94baff921;
