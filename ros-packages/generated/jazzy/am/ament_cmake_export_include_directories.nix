...
let
  sources = rec {
    ament_cmake_export_include_directories-285da55baa18a327b0357d4c192e2ac34b1758fe = substituteSource {
      src = fetchgit {
        name = "ament_cmake_export_include_directories-285da55baa18a327b0357d4c192e2ac34b1758fe-source";
...
buildRosPackage {
  ...
  version = "2.5.2-1";
  src = sources.ament_cmake_export_include_directories-285da55baa18a327b0357d4c192e2ac34b1758fe;
