...
let
  sources = rec {
    octomap-895657943d1ba59b781d1c1da097dab12568b016 = substituteSource {
      src = fetchgit {
        name = "octomap-895657943d1ba59b781d1c1da097dab12568b016-source";
...
buildRosPackage {
  pname = "octomap";
  version = "1.10.0-4";
  src = sources.octomap-895657943d1ba59b781d1c1da097dab12568b016;
