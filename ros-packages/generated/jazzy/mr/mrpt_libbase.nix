...
let
  sources = rec {
    mrpt_libbase-86c7baaf6fa0b4431537e968078fe8ef2bd3b4aa = substituteSource {
      src = fetchgit {
        name = "mrpt_libbase-86c7baaf6fa0b4431537e968078fe8ef2bd3b4aa-source";
...
buildRosPackage {
  pname = "mrpt_libbase";
  version = "2.14.1-1";
  src = sources.mrpt_libbase-86c7baaf6fa0b4431537e968078fe8ef2bd3b4aa;
