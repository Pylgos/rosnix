...
let
  sources = rec {
    mrt_cmake_modules-594a0a1eeaf421f36e68f2912c1d1c7368d44ae0 = substituteSource {
      src = fetchgit {
        name = "mrt_cmake_modules-594a0a1eeaf421f36e68f2912c1d1c7368d44ae0-source";
...
buildRosPackage {
  ...
  version = "1.0.11-2";
  src = sources.mrt_cmake_modules-594a0a1eeaf421f36e68f2912c1d1c7368d44ae0;
