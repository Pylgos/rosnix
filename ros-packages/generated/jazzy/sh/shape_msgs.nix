...
let
  sources = rec {
    shape_msgs-79f7106056e38493dc72b9ab32567657a1b2bead = substituteSource {
      src = fetchgit {
        name = "shape_msgs-79f7106056e38493dc72b9ab32567657a1b2bead-source";
...
buildRosPackage {
  pname = "shape_msgs";
  version = "5.3.5-1";
  src = sources.shape_msgs-79f7106056e38493dc72b9ab32567657a1b2bead;
