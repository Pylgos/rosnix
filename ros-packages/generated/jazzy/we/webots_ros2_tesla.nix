...
let
  sources = rec {
    webots_ros2_tesla-d233344bc73905dd94849ea6965b8fbaccdf5136 = substituteSource {
      src = fetchgit {
        name = "webots_ros2_tesla-d233344bc73905dd94849ea6965b8fbaccdf5136-source";
...
buildRosPackage {
  ...
  version = "2023.1.3-1";
  src = sources.webots_ros2_tesla-d233344bc73905dd94849ea6965b8fbaccdf5136;
