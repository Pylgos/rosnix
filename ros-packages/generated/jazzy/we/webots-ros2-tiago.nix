...
buildAmentPythonPackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ builtin-interfaces controller-manager diff-drive-controller geometry-msgs joint-state-broadcaster robot-state-publisher rviz2 tf2-ros webots-ros2-control webots-ros2-driver ];
