...
let
  sources = rec {
    ecl_sigslots-3538d06591cc853d4e0cdef4e822477bd8125aac = substituteSource {
      src = fetchgit {
        name = "ecl_sigslots-3538d06591cc853d4e0cdef4e822477bd8125aac-source";
...
buildRosPackage {
  pname = "ecl_sigslots";
  version = "1.2.1-5";
  src = sources.ecl_sigslots-3538d06591cc853d4e0cdef4e822477bd8125aac;
