...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ rclcpp rmw-implementation-cmake ];
  propagatedBuildInputs = [ example-interfaces launch-ros rclcpp-components rcutils rmw sensor-msgs std-msgs ];
