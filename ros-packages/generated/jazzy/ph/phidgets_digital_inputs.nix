...
let
  sources = rec {
    phidgets_digital_inputs-28b6e1c5cba7484cc3c576b6ea9baaa9fe9e7be5 = substituteSource {
      src = fetchgit {
        name = "phidgets_digital_inputs-28b6e1c5cba7484cc3c576b6ea9baaa9fe9e7be5-source";
...
buildRosPackage {
  ...
  version = "2.3.3-2";
  src = sources.phidgets_digital_inputs-28b6e1c5cba7484cc3c576b6ea9baaa9fe9e7be5;
