...
let
  sources = rec {
    twist_mux-025308b135ade9fed08cd4b41ec8148cfbf95f08 = substituteSource {
      src = fetchgit {
        name = "twist_mux-025308b135ade9fed08cd4b41ec8148cfbf95f08-source";
...
buildRosPackage {
  pname = "twist_mux";
  version = "4.3.0-3";
  src = sources.twist_mux-025308b135ade9fed08cd4b41ec8148cfbf95f08;
