...
let
  sources = rec {
    urdf_tutorial-768fb035b41a3366d0bd4c5088643a7b8b411276 = substituteSource {
      src = fetchgit {
        name = "urdf_tutorial-768fb035b41a3366d0bd4c5088643a7b8b411276-source";
...
buildRosPackage {
  pname = "urdf_tutorial";
  version = "1.1.0-3";
  src = sources.urdf_tutorial-768fb035b41a3366d0bd4c5088643a7b8b411276;
