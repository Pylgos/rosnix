...
let
  sources = rec {
    libnabo-160592c7ea514f53d953d86d718910a908cbfd21 = substituteSource {
      src = fetchgit {
        name = "libnabo-160592c7ea514f53d953d86d718910a908cbfd21-source";
...
buildRosPackage {
  pname = "libnabo";
  version = "1.1.1-2";
  src = sources.libnabo-160592c7ea514f53d953d86d718910a908cbfd21;
