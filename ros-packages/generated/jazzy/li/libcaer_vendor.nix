...
let
  sources = rec {
    ...
    libcaer_vendor-0424ca45235d713578a786c73480717ad9b316d6 = substituteSource {
      src = fetchgit {
        name = "libcaer_vendor-0424ca45235d713578a786c73480717ad9b316d6-source";
...
buildRosPackage {
  ...
  version = "1.3.0-1";
  src = sources.libcaer_vendor-0424ca45235d713578a786c73480717ad9b316d6;
