...
let
  sources = rec {
    moveit_runtime-2ddde4274e5e80ea818897525648caaf6cdd54ac = substituteSource {
      src = fetchgit {
        name = "moveit_runtime-2ddde4274e5e80ea818897525648caaf6cdd54ac-source";
...
buildRosPackage {
  ...
  version = "2.10.0-1";
  src = sources.moveit_runtime-2ddde4274e5e80ea818897525648caaf6cdd54ac;
