...
let
  sources = rec {
    fluent_rviz-dfc47e81339f939273e719512fd2ddac32195178 = substituteSource {
      src = fetchgit {
        name = "fluent_rviz-dfc47e81339f939273e719512fd2ddac32195178-source";
...
buildRosPackage {
  pname = "fluent_rviz";
  version = "0.0.3-4";
  src = sources.fluent_rviz-dfc47e81339f939273e719512fd2ddac32195178;
