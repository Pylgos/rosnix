...
let
  sources = rec {
    ament_cmake_catch2-61bb4fbe02d9fce298cde363e258d9993043640d = substituteSource {
      src = fetchgit {
        name = "ament_cmake_catch2-61bb4fbe02d9fce298cde363e258d9993043640d-source";
...
buildRosPackage {
  ...
  version = "1.5.0-1";
  src = sources.ament_cmake_catch2-61bb4fbe02d9fce298cde363e258d9993043640d;
