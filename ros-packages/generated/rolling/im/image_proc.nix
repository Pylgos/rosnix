...
let
  sources = rec {
    image_proc-da99ae6aa8c0154311d4738355e39ec3bc17f07f = substituteSource {
      src = fetchgit {
        name = "image_proc-da99ae6aa8c0154311d4738355e39ec3bc17f07f-source";
...
buildRosPackage {
  pname = "image_proc";
  version = "6.0.3-1";
  src = sources.image_proc-da99ae6aa8c0154311d4738355e39ec3bc17f07f;
