...
let
  sources = rec {
    tf2_ros-f8849d12950b3d5dde2ace207ec64b8c309decc5 = substituteSource {
      src = fetchgit {
        name = "tf2_ros-f8849d12950b3d5dde2ace207ec64b8c309decc5-source";
...
buildRosPackage {
  pname = "tf2_ros";
  version = "0.38.2-1";
  src = sources.tf2_ros-f8849d12950b3d5dde2ace207ec64b8c309decc5;
