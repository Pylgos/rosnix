...
let
  sources = rec {
    tf2_msgs-f0a62d46309e2f380187ede79465c5a3d1d641be = substituteSource {
      src = fetchgit {
        name = "tf2_msgs-f0a62d46309e2f380187ede79465c5a3d1d641be-source";
...
buildRosPackage {
  pname = "tf2_msgs";
  version = "0.38.2-1";
  src = sources.tf2_msgs-f0a62d46309e2f380187ede79465c5a3d1d641be;
