...
let
  sources = rec {
    fuse_graphs-f25e0c77ca4aed1f08bed1053c0f08ba9eb03867 = substituteSource {
      src = fetchgit {
        name = "fuse_graphs-f25e0c77ca4aed1f08bed1053c0f08ba9eb03867-source";
...
buildRosPackage {
  pname = "fuse_graphs";
  version = "1.2.1-1";
  src = sources.fuse_graphs-f25e0c77ca4aed1f08bed1053c0f08ba9eb03867;
