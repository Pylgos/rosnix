...
let
  sources = rec {
    mrpt_apps-e9fc6a6c64bc63418f21cdd39ae34113dc658780 = substituteSource {
      src = fetchgit {
        name = "mrpt_apps-e9fc6a6c64bc63418f21cdd39ae34113dc658780-source";
...
buildRosPackage {
  pname = "mrpt_apps";
  version = "2.14.1-1";
  src = sources.mrpt_apps-e9fc6a6c64bc63418f21cdd39ae34113dc658780;
