...
let
  sources = rec {
    mrpt_rawlog-8bd9fea30a3470168a82c2d34b6abc8f94908e69 = substituteSource {
      src = fetchgit {
        name = "mrpt_rawlog-8bd9fea30a3470168a82c2d34b6abc8f94908e69-source";
...
buildRosPackage {
  pname = "mrpt_rawlog";
  version = "2.2.0-1";
  src = sources.mrpt_rawlog-8bd9fea30a3470168a82c2d34b6abc8f94908e69;
