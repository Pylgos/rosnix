...
let
  sources = rec {
    ...
    iceoryx_posh-9b8d8e7f7fa37a5e54a1a9efb34970862fe63229 = substituteSource {
      src = fetchgit {
        name = "iceoryx_posh-9b8d8e7f7fa37a5e54a1a9efb34970862fe63229-source";
...
buildRosPackage {
  pname = "iceoryx_posh";
  version = "2.0.5-5";
  src = sources.iceoryx_posh-9b8d8e7f7fa37a5e54a1a9efb34970862fe63229;
