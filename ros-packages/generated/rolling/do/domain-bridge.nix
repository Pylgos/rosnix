...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ rclcpp rclcpp-components rcutils rosbag2-cpp rosidl-default-runtime rosidl-typesupport-cpp ] ++ rosSystemPackages.getPackages { forNativeBuildInputs = [ "yaml-cpp" "zstd_vendor" ]; };
  buildInputs = [ ament-cmake rosidl-default-generators ];
  propagatedBuildInputs = [ rclcpp rclcpp-components rcutils rosbag2-cpp rosidl-default-runtime rosidl-typesupport-cpp ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "yaml-cpp" "zstd_vendor" ]; };
