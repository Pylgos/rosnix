...
let
  sources = rec {
    rmf_task_sequence-59ff2883fb336b1d94a155b748e49598b5cd714c = substituteSource {
      src = fetchgit {
        name = "rmf_task_sequence-59ff2883fb336b1d94a155b748e49598b5cd714c-source";
...
buildRosPackage {
  ...
  version = "2.6.0-1";
  src = sources.rmf_task_sequence-59ff2883fb336b1d94a155b748e49598b5cd714c;
