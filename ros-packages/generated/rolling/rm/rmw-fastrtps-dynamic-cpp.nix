...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ fastcdr fastdds rcutils rmw rmw-dds-common rmw-fastrtps-shared-cpp rosidl-runtime-c rosidl-typesupport-introspection-c rosidl-typesupport-introspection-cpp ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rmw_fastrtps_dynamic_cpp" = substituteSource {
      src = fetchgit {
        ...
        rev = "cfe42f4dbc64f8fb622611b77818fd8f117b4658";
        hash = "sha256-h5J0ZIZGMJvf9sZVgTkmd9op+NRjfPEc0gSZLi1jiUM=";
      };
    };
  });
  meta = {
