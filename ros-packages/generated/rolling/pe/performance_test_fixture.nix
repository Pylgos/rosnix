...
let
  sources = rec {
    performance_test_fixture-14ec312609f7e0fbdcde3ddf707c4d8ba7a0da2d = substituteSource {
      src = fetchgit {
        name = "performance_test_fixture-14ec312609f7e0fbdcde3ddf707c4d8ba7a0da2d-source";
...
buildRosPackage {
  ...
  version = "0.3.1-1";
  src = sources.performance_test_fixture-14ec312609f7e0fbdcde3ddf707c4d8ba7a0da2d;
