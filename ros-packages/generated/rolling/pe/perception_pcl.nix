...
let
  sources = rec {
    perception_pcl-c6d5610ecc4b14db1155d4cf0dc3fcd20b777111 = substituteSource {
      src = fetchgit {
        name = "perception_pcl-c6d5610ecc4b14db1155d4cf0dc3fcd20b777111-source";
...
buildRosPackage {
  ...
  version = "2.6.1-3";
  src = sources.perception_pcl-c6d5610ecc4b14db1155d4cf0dc3fcd20b777111;
