...
buildRosPackage {
  ...
  propagatedBuildInputs = [ gz-math-vendor gz-tools-vendor gz-utils-vendor ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "liburdfdom-dev" "pybind11-dev" "sdformat15" "tinyxml2" ]; };
