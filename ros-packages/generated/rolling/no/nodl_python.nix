...
let
  sources = rec {
    nodl_python-b699bd8f49e8cd26b642940300bdecdc79a5a2c7 = substituteSource {
      src = fetchgit {
        name = "nodl_python-b699bd8f49e8cd26b642940300bdecdc79a5a2c7-source";
...
buildRosPackage {
  pname = "nodl_python";
  version = "0.3.1-4";
  src = sources.nodl_python-b699bd8f49e8cd26b642940300bdecdc79a5a2c7;
