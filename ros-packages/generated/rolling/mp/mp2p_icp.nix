...
let
  sources = rec {
    mp2p_icp-81ab7380e7b6adc782b22cc63c012361e90da6f2 = substituteSource {
      src = fetchgit {
        name = "mp2p_icp-81ab7380e7b6adc782b22cc63c012361e90da6f2-source";
...
buildRosPackage {
  pname = "mp2p_icp";
  version = "1.6.2-1";
  src = sources.mp2p_icp-81ab7380e7b6adc782b22cc63c012361e90da6f2;
