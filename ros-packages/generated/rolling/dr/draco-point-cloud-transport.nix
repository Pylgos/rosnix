...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ pluginlib point-cloud-interfaces point-cloud-transport rclcpp sensor-msgs std-msgs ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "libdraco-dev" ]; };
