...
let
  sources = rec {
    delphi_esr_msgs-96b9241b12511f5374df1fc6997f3f5cb9803bd4 = substituteSource {
      src = fetchgit {
        name = "delphi_esr_msgs-96b9241b12511f5374df1fc6997f3f5cb9803bd4-source";
...
buildRosPackage {
  ...
  version = "4.0.0-3";
  src = sources.delphi_esr_msgs-96b9241b12511f5374df1fc6997f3f5cb9803bd4;
