...
let
  sources = rec {
    control_box_rst-3c1ca1427892e0856bed0da711fd6d3e71f9f193 = substituteSource {
      src = fetchgit {
        name = "control_box_rst-3c1ca1427892e0856bed0da711fd6d3e71f9f193-source";
...
buildRosPackage {
  ...
  version = "0.0.7-5";
  src = sources.control_box_rst-3c1ca1427892e0856bed0da711fd6d3e71f9f193;
