...
let
  sources = rec {
    foonathan_memory_vendor-2cd4ec778b044b01ae8f85280a82a4fb23982444 = substituteSource {
      src = fetchgit {
        name = "foonathan_memory_vendor-2cd4ec778b044b01ae8f85280a82a4fb23982444-source";
...
buildRosPackage {
  ...
  version = "1.3.1-2";
  src = sources.foonathan_memory_vendor-2cd4ec778b044b01ae8f85280a82a4fb23982444;
