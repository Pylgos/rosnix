...
let
  sources = rec {
    ecl_converters_lite-da9921de2be3c1b5e77124804d56bbcfbe9d47d2 = substituteSource {
      src = fetchgit {
        name = "ecl_converters_lite-da9921de2be3c1b5e77124804d56bbcfbe9d47d2-source";
...
buildRosPackage {
  ...
  version = "1.2.0-4";
  src = sources.ecl_converters_lite-da9921de2be3c1b5e77124804d56bbcfbe9d47d2;
