...
let
  sources = rec {
    ecl_build-fc70f1b1c5cf842334208f73a41fbf56d910eacb = substituteSource {
      src = fetchgit {
        name = "ecl_build-fc70f1b1c5cf842334208f73a41fbf56d910eacb-source";
...
buildRosPackage {
  pname = "ecl_build";
  version = "1.0.3-4";
  src = sources.ecl_build-fc70f1b1c5cf842334208f73a41fbf56d910eacb;
