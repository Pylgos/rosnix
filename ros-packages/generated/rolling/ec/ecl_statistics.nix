...
let
  sources = rec {
    ecl_statistics-c0e8d8dd7d93057ac24bd8beac89d9212a1a99a2 = substituteSource {
      src = fetchgit {
        name = "ecl_statistics-c0e8d8dd7d93057ac24bd8beac89d9212a1a99a2-source";
...
buildRosPackage {
  ...
  version = "1.2.1-4";
  src = sources.ecl_statistics-c0e8d8dd7d93057ac24bd8beac89d9212a1a99a2;
