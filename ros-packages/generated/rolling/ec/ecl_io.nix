...
let
  sources = rec {
    ecl_io-1e442ac33f0c10fc58b575420ecb1ef33f79a277 = substituteSource {
      src = fetchgit {
        name = "ecl_io-1e442ac33f0c10fc58b575420ecb1ef33f79a277-source";
...
buildRosPackage {
  pname = "ecl_io";
  version = "1.2.0-4";
  src = sources.ecl_io-1e442ac33f0c10fc58b575420ecb1ef33f79a277;
