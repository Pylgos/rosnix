...
let
  sources = rec {
    phidgets_analog_outputs-59e5913311216077f491d0545d7633bc6d19d107 = substituteSource {
      src = fetchgit {
        name = "phidgets_analog_outputs-59e5913311216077f491d0545d7633bc6d19d107-source";
...
buildRosPackage {
  ...
  version = "2.3.3-1";
  src = sources.phidgets_analog_outputs-59e5913311216077f491d0545d7633bc6d19d107;
