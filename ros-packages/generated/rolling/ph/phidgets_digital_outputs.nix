...
let
  sources = rec {
    phidgets_digital_outputs-19a417adb7755b9c791486703491c84a77a2e5af = substituteSource {
      src = fetchgit {
        name = "phidgets_digital_outputs-19a417adb7755b9c791486703491c84a77a2e5af-source";
...
buildRosPackage {
  ...
  version = "2.3.3-1";
  src = sources.phidgets_digital_outputs-19a417adb7755b9c791486703491c84a77a2e5af;
