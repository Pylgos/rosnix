...
let
  sources = rec {
    phidgets_high_speed_encoder-d15cb831059418291e61ba4877bbef999cc57107 = substituteSource {
      src = fetchgit {
        name = "phidgets_high_speed_encoder-d15cb831059418291e61ba4877bbef999cc57107-source";
...
buildRosPackage {
  ...
  version = "2.3.3-1";
  src = sources.phidgets_high_speed_encoder-d15cb831059418291e61ba4877bbef999cc57107;
