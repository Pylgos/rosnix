...
let
  sources = rec {
    examples_rclpy_pointcloud_publisher-7cd335317211a164d296178dad487d918551d8a6 = substituteSource {
      src = fetchgit {
        name = "examples_rclpy_pointcloud_publisher-7cd335317211a164d296178dad487d918551d8a6-source";
...
buildRosPackage {
  ...
  version = "0.20.2-1";
  src = sources.examples_rclpy_pointcloud_publisher-7cd335317211a164d296178dad487d918551d8a6;
