...
let
  sources = rec {
    joy_linux-3ba3794b6061c3c7a1ed7904cbc5d337a57c6fec = substituteSource {
      src = fetchgit {
        name = "joy_linux-3ba3794b6061c3c7a1ed7904cbc5d337a57c6fec-source";
...
buildRosPackage {
  pname = "joy_linux";
  version = "3.3.0-2";
  src = sources.joy_linux-3ba3794b6061c3c7a1ed7904cbc5d337a57c6fec;
