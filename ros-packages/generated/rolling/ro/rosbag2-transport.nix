...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ keyboard-handler rclcpp-action rclcpp-components rcutils rmw rosbag2-compression rosbag2-cpp rosbag2-interfaces rosbag2-storage yaml-cpp-vendor ];
