...
let
  sources = rec {
    ros_industrial_cmake_boilerplate-955034a0e53d423d818c9d966f88ea1e002e06d3 = substituteSource {
      src = fetchgit {
        name = "ros_industrial_cmake_boilerplate-955034a0e53d423d818c9d966f88ea1e002e06d3-source";
...
buildRosPackage {
  ...
  version = "0.5.4-1";
  src = sources.ros_industrial_cmake_boilerplate-955034a0e53d423d818c9d966f88ea1e002e06d3;
