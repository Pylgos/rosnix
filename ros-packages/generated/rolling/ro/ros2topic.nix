...
buildAmentPythonPackage (finalAttrs: {
  ...
  propagatedBuildInputs = [ ros2cli rosidl-runtime-py ] ++ rosSystemPackages.getPackages { forBuildInputs = [ "python3-numpy" ]; };
  ...
  passthru.sources = mkSourceSet (sources: {
    "ros2topic" = substituteSource {
      src = fetchgit {
        ...
        rev = "f40e3c0d52060b6ed12bbcbaa09d0955dc0d11e0";
        hash = "sha256-faakhrHTMQL5Wrg5Sv1QPNJtS/IzL2VC+hGq1IWRtqQ=";
      };
    };
  });
  meta = {
