...
let
  sources = rec {
    generate_parameter_module_example-9cc2325f63634db9965e347430e91d30465bbc82 = substituteSource {
      src = fetchgit {
        name = "generate_parameter_module_example-9cc2325f63634db9965e347430e91d30465bbc82-source";
...
buildRosPackage {
  ...
  version = "0.3.8-3";
  src = sources.generate_parameter_module_example-9cc2325f63634db9965e347430e91d30465bbc82;
