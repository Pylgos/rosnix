...
let
  sources = rec {
    rclc_examples-7d0294f2f2fc9eae07bef07bbab2a53578465a60 = substituteSource {
      src = fetchgit {
        name = "rclc_examples-7d0294f2f2fc9eae07bef07bbab2a53578465a60-source";
...
buildRosPackage {
  pname = "rclc_examples";
  version = "6.1.0-2";
  src = sources.rclc_examples-7d0294f2f2fc9eae07bef07bbab2a53578465a60;
