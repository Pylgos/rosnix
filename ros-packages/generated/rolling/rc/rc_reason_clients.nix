...
let
  sources = rec {
    rc_reason_clients-af93ddd068abc4bc24953d9e9c81235f1bd29b58 = substituteSource {
      src = fetchgit {
        name = "rc_reason_clients-af93ddd068abc4bc24953d9e9c81235f1bd29b58-source";
...
buildRosPackage {
  ...
  version = "0.3.1-2";
  src = sources.rc_reason_clients-af93ddd068abc4bc24953d9e9c81235f1bd29b58;
