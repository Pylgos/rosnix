...
let
  sources = rec {
    moveit_ros-d8dec5fc61afd7dae561b5faf139ecb9441b5e1d = substituteSource {
      src = fetchgit {
        name = "moveit_ros-d8dec5fc61afd7dae561b5faf139ecb9441b5e1d-source";
...
buildRosPackage {
  pname = "moveit_ros";
  version = "2.11.0-1";
  src = sources.moveit_ros-d8dec5fc61afd7dae561b5faf139ecb9441b5e1d;
