...
let
  sources = rec {
    moveit_py-b28cdc0b5a4ec7a3e2fa9027441d69a0d8bbcf50 = substituteSource {
      src = fetchgit {
        name = "moveit_py-b28cdc0b5a4ec7a3e2fa9027441d69a0d8bbcf50-source";
...
buildRosPackage {
  pname = "moveit_py";
  version = "2.11.0-1";
  src = sources.moveit_py-b28cdc0b5a4ec7a3e2fa9027441d69a0d8bbcf50;
