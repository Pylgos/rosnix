...
let
  sources = rec {
    tango_icons_vendor-e452bedb4beb3b68a82a6e5bfcf8b7a5e055319a = substituteSource {
      src = fetchgit {
        name = "tango_icons_vendor-e452bedb4beb3b68a82a6e5bfcf8b7a5e055319a-source";
...
buildRosPackage {
  ...
  version = "0.4.0-1";
  src = sources.tango_icons_vendor-e452bedb4beb3b68a82a6e5bfcf8b7a5e055319a;
