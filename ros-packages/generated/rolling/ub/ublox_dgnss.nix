...
let
  sources = rec {
    ublox_dgnss-bff93c47d5c2d066be278b8d207ee821b12d6c3e = substituteSource {
      src = fetchgit {
        name = "ublox_dgnss-bff93c47d5c2d066be278b8d207ee821b12d6c3e-source";
...
buildRosPackage {
  pname = "ublox_dgnss";
  version = "0.5.3-1";
  src = sources.ublox_dgnss-bff93c47d5c2d066be278b8d207ee821b12d6c3e;
