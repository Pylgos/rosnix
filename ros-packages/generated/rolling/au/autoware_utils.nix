...
let
  sources = rec {
    autoware_utils-2e391696f0073bf87109a01b9fd4e3d43f0a280c = substituteSource {
      src = fetchgit {
        name = "autoware_utils-2e391696f0073bf87109a01b9fd4e3d43f0a280c-source";
...
buildRosPackage {
  ...
  version = "1.0.0-1";
  src = sources.autoware_utils-2e391696f0073bf87109a01b9fd4e3d43f0a280c;
