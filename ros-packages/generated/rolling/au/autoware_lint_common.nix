...
let
  sources = rec {
    autoware_lint_common-bd9cf635bb1cc7f8d9fed68f017322e6f7d80a46 = substituteSource {
      src = fetchgit {
        name = "autoware_lint_common-bd9cf635bb1cc7f8d9fed68f017322e6f7d80a46-source";
...
buildRosPackage {
  ...
  version = "1.0.0-1";
  src = sources.autoware_lint_common-bd9cf635bb1cc7f8d9fed68f017322e6f7d80a46;
