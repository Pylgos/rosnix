  ...
  sources = mkSourceSet (sources: {
    "python_mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "0c9cd4f2e70c49605fb16a04bab6f38e3eb9212b";
        hash = "sha256-k9X3mcLWfANspDb11FU56Z/qZqfgrk8qHUhMFOctkv0=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "python_mrpt/mrpt" = substituteSource {
      src = fetchgit {
        ...
        rev = "26ee5f99cf47d7bd018f062f766603df60f81c9a";
        hash = "sha256-FVHMTtpoudz0NVNlAl1Rn8Sfp1ooTT0uRA2P2yYXzxI=";
      };
      substitutions = [
        {
