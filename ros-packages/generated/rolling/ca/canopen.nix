...
let
  sources = rec {
    canopen-2295c5b5328ef7bb5ac8f10f956390d9fd405e80 = substituteSource {
      src = fetchgit {
        name = "canopen-2295c5b5328ef7bb5ac8f10f956390d9fd405e80-source";
...
buildRosPackage {
  pname = "canopen";
  version = "0.2.12-2";
  src = sources.canopen-2295c5b5328ef7bb5ac8f10f956390d9fd405e80;
