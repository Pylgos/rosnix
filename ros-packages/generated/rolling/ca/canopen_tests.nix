...
let
  sources = rec {
    canopen_tests-78c9872e36b6324e4b7205c26514913a080e7457 = substituteSource {
      src = fetchgit {
        name = "canopen_tests-78c9872e36b6324e4b7205c26514913a080e7457-source";
...
buildRosPackage {
  pname = "canopen_tests";
  version = "0.2.12-2";
  src = sources.canopen_tests-78c9872e36b6324e4b7205c26514913a080e7457;
