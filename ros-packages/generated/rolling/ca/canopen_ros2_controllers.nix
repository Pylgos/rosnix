...
let
  sources = rec {
    canopen_ros2_controllers-6d54a85e5ba27d48ce477bfed1f7ea3e8d562c71 = substituteSource {
      src = fetchgit {
        name = "canopen_ros2_controllers-6d54a85e5ba27d48ce477bfed1f7ea3e8d562c71-source";
...
buildRosPackage {
  ...
  version = "0.2.12-2";
  src = sources.canopen_ros2_controllers-6d54a85e5ba27d48ce477bfed1f7ea3e8d562c71;
