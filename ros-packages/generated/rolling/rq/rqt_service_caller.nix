...
let
  sources = rec {
    rqt_service_caller-c695cb4b04aac9d38fc7eb36033f69144d2c5381 = substituteSource {
      src = fetchgit {
        name = "rqt_service_caller-c695cb4b04aac9d38fc7eb36033f69144d2c5381-source";
...
buildRosPackage {
  ...
  version = "1.3.0-1";
  src = sources.rqt_service_caller-c695cb4b04aac9d38fc7eb36033f69144d2c5381;
