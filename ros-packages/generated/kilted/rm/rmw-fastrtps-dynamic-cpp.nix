...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ fastcdr fastdds rcpputils rcutils rmw rmw-dds-common rmw-fastrtps-shared-cpp rosidl-runtime-c rosidl-typesupport-introspection-c rosidl-typesupport-introspection-cpp tracetools ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rmw_fastrtps_dynamic_cpp" = substituteSource {
      src = fetchgit {
        ...
        rev = "8b0c1c79531cc13a54c05ed26b2ed0c81444e4b9";
        hash = "sha256-0qdsfe/Zby4LNgaTmYHTZdwsuOcyYy2xcCpOVXRNbDw=";
      };
    };
  });
  meta = {
