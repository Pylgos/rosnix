...
buildAmentCmakePackage (finalAttrs: {
  ...
  propagatedNativeBuildInputs = [ fastcdr fastdds rcpputils rcutils rmw rmw-dds-common rmw-fastrtps-shared-cpp rosidl-dynamic-typesupport rosidl-dynamic-typesupport-fastrtps rosidl-runtime-c rosidl-runtime-cpp rosidl-typesupport-fastrtps-c rosidl-typesupport-fastrtps-cpp tracetools ];
  ...
  passthru.sources = mkSourceSet (sources: {
    "rmw_fastrtps_cpp" = substituteSource {
      src = fetchgit {
        ...
        rev = "c7aebe5ecac17e223fc1ed29cd2df5c8391ad283";
        hash = "sha256-kiz/vufa8z91zGwcQ+Wc6yfSf4BpQTfNejhen7oj4hA=";
      };
    };
  });
  meta = {
