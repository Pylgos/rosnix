  ...
  passthru.sources = mkSourceSet (sources: {
    "gz_common_vendor" = substituteSource {
      src = fetchgit {
        ...
        rev = "382185183097cdf6aba0f7e5ae9853b738597b95";
        hash = "sha256-DSU0dnNuwW870v5URsvR96oiBjhOb0TyX0WCHu8OmxM=";
      };
      substitutions = [
        {
          path = "CMakeLists.txt";
    ...
    "gz_common_vendor/gz-common" = substituteSource {
      src = fetchgit {
        ...
        rev = "51de9ab8b44dc060cbdcdde6d771b0dac30584cb";
        hash = "sha256-Nt5Egt9mCXesI3x1ytBkNxINaR7Xdm5gIh8yeYEQNsE=";
      };
    };
  });
  meta = {
    description = "\n    Vendor package for: gz-common6 6.3.0\n\n    Gazebo Common : AV, Graphics, Events, and much more.\n  ";
  };
})
